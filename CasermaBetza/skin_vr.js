...
function pano2vrVrSkin(player, base) {
  ...
  this.getElementVrPosition = function (el, x, y) {
    var vrPos = {};
    var renderableEl =
      el.parent && (el.parent.type == "Mesh" || el.parent.type == "Group");
    switch (el.userData.hanchor) {
      case 0:
        vrPos.x =
          (renderableEl ? el.parent.position.x : 0) -
          (renderableEl ? el.parent.userData.width : 800) / 200.0 +
          x / 100.0 +
          el.userData.width / 200.0;
        break;
      case 1:
    ...
    switch (el.userData.vanchor) {
      case 0:
        vrPos.y =
          (renderableEl ? el.parent.position.y : 0) +
          (renderableEl ? el.parent.userData.height : 600) / 200.0 -
          y / 100.0 -
          el.userData.height / 200.0;
        break;
      case 1:
  ...
  this.addSkin = function () {
    ...
    el.userData.scale = { x: 1.0, y: 1.0, z: 1.0 };
    ...
    me._thumbnails.logicBlock_visible = function () {
      ...
      if (me._thumbnails.ggCurrentLogicStateVisible != newLogicStateVisible) {
        ...
        if (me._thumbnails.ggCurrentLogicStateVisible == 0) {
          ...
          me._thumbnails.visible =
            (!me._thumbnails.material &&
              Number(me._thumbnails.userData.opacity > 0)) ||
            Number(me._thumbnails.material.opacity) > 0
              ? true
              : false;
    ...
    el.userData.ggGoUp = function () {
      if (
        me._node_cloner_vr.userData.ggCloneOffset +
          me._node_cloner_vr.userData.ggNumCols <=
    ...
    el.userData.ggGoDown = function () {
      if (me._node_cloner_vr.userData.ggCloneOffset > 0) {
        me._node_cloner_vr.userData.ggCloneOffset -=
          me._node_cloner_vr.userData.ggNumCols;
        me._node_cloner_vr.userData.ggCloneOffset = Math.max(
          me._node_cloner_vr.userData.ggCloneOffset,
          0
        );
        me._node_cloner_vr.userData.ggCloneOffsetChanged = true;
    ...
    el.userData.ggUpdate = function (filter) {
      ...
      me._node_cloner_vr.userData.offsetLeft =
        me._node_cloner_vr.parent.userData.width / 200.0 +
        me._node_cloner_vr.userData.x -
        me._node_cloner_vr.userData.width / 200.0;
      curNumCols = Math.floor(
        ((parentWidth - me._node_cloner_vr.userData.offsetLeft) *
          me._node_cloner_vr.userData.ggNumRepeat) /
          100.0 /
          me._node_cloner_vr.userData.width
      );
      ...
      if (
        ...
        el.userData.ggInstances.length > 0 &&
        filter.length === el.userData.ggCurrentFilter.length &&
        filter.every(function (value, index) {
          return value === el.userData.ggCurrentFilter[index];
        }) &&
        false
      ) {
        ...
        centerOffsetHor =
          ((parentWidth - me._node_cloner_vr.userData.offsetLeft * 100.0) %
            me._node_cloner_vr.userData.width) /
          2;
      ...
      if (
        parentWidth - me._node_cloner_vr.userData.offsetLeft * 100.0 >
        me._node_cloner_vr.userData.width * numNodes
      ) {
        centerOffsetHor =
          (parentWidth -
            me._node_cloner_vr.userData.offsetLeft * 100.0 -
            me._node_cloner_vr.userData.width * numNodes) /
          2;
      }
      ...
      for (var i = 0; i < tourNodes.length; i++) {
        var nodeId = tourNodes[i];
        var nodeData = player.getNodeUserdata(nodeId);
        if (!keepCloning || i < me._node_cloner_vr.userData.ggCloneOffset)
          continue;
        var parameter = {};
        parameter.top =
          -(centerOffsetVert / 100.0) -
          (row * me._node_cloner_vr.userData.height) / 100.0;
        parameter.left =
          centerOffsetHor / 100.0 +
          (column * me._node_cloner_vr.userData.width) / 100.0;
        parameter.index = currentIndex;
        parameter.title = nodeData["title"];
        var inst = new SkinCloner_node_cloner_vr_Class(
          nodeId,
          me,
          el,
          parameter
        ...
        if (
          bbox.min.x + clonerPosInSkin.x >= -4 &&
          bbox.max.x + clonerPosInSkin.x <= 4 &&
          bbox.min.y + clonerPosInSkin.y >= -3 &&
          bbox.max.y + clonerPosInSkin.y <= 3
        )
          el.add(inst.__obj);
        column++;
      ...
      player.setVariableValue(
        "node_cloner_vr_hasDown",
        me._node_cloner_vr.userData.ggCloneOffset > 0
      );
      player.setVariableValue(
        "node_cloner_vr_hasUp",
        me._node_cloner_vr.userData.ggCloneOffset +
          me._node_cloner_vr.userData.ggNumCols <
          me._node_cloner_vr.userData.ggNumFilterPassed
      );
      me._node_cloner_vr.userData.ggNodeCount =
        me._node_cloner_vr.userData.ggNumFilterPassed;
      me._node_cloner_vr.userData.ggUpdating = false;
    ...
    el.userData.setOpacityInternal = function (v) {
      me._page_up_bg.material.opacity =
        v * me._page_up_bg.userData.backgroundColorAlpha;
      if (me._page_up_bg.userData.ggSubElement) {
        me._page_up_bg.userData.ggSubElement.material.opacity = v;
        me._page_up_bg.userData.ggSubElement.visible =
          v > 0 && me._page_up_bg.userData.visible;
      }
    ...
    me._page_up_bg.logicBlock_scaling = function () {
      ...
      if (me.elementMouseOver["page_up_bg"] == true) {
      ...
      if (me._page_up_bg.ggCurrentLogicStateScaling != newLogicStateScaling) {
        ...
        if (me._page_up_bg.ggCurrentLogicStateScaling == 0) {
          me._page_up_bg.userData.transitionValue_scale = {
            x: 1.2,
            y: 1.2,
            z: 1.0,
          };
          ...
          transition_scale.interval = setInterval(() => {
            ...
            let percentDone =
              (1.0 * (currentTime - transition_scale.startTime)) / 300;
            percentDone = Math.max(percentDone, 0.0);
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._page_up_bg.scale.set(
              transition_scale.startScale.x +
                (me._page_up_bg.userData.transitionValue_scale.x -
                  transition_scale.startScale.x) *
                  tfval,
              transition_scale.startScale.y +
                (me._page_up_bg.userData.transitionValue_scale.y -
                  transition_scale.startScale.y) *
                  tfval,
              1.0
            );
            var scaleOffX = 0;
            var scaleOffY = 0;
            me._page_up_bg.position.x =
              me._page_up_bg.position.x -
              me._page_up_bg.userData.curScaleOffX +
              scaleOffX;
            me._page_up_bg.userData.curScaleOffX = scaleOffX;
            me._page_up_bg.position.y =
              me._page_up_bg.position.y -
              me._page_up_bg.userData.curScaleOffY +
              scaleOffY;
            me._page_up_bg.userData.curScaleOffY = scaleOffY;
            if (percentDone >= 1.0) {
              clearInterval(transition_scale.interval);
              me._page_up_bg.userData.transitions.splice(
                me._page_up_bg.userData.transitions.indexOf(transition_scale),
                1
              );
            }
          }, 20);
    ...
    me._page_up_bg.logicBlock_visible = function () {
      var newLogicStateVisible;
      if (player.getVariableValue("node_cloner_vr_hasUp") == true) {
        newLogicStateVisible = 0;
      } else {
        newLogicStateVisible = -1;
      }
      if (me._page_up_bg.ggCurrentLogicStateVisible != newLogicStateVisible) {
        ...
        if (me._page_up_bg.ggCurrentLogicStateVisible == 0) {
          me._page_up_bg.visible =
            (!me._page_up_bg.material &&
              Number(me._page_up_bg.userData.opacity > 0)) ||
            Number(me._page_up_bg.material.opacity) > 0
              ? true
              : false;
    ...
    el.userData.borderColorAlpha = 1;
    el.userData.setOpacityInternal = function (v) {
      me._page_down_bg.material.opacity =
        v * me._page_down_bg.userData.backgroundColorAlpha;
      if (me._page_down_bg.userData.ggSubElement) {
        me._page_down_bg.userData.ggSubElement.material.opacity = v;
        me._page_down_bg.userData.ggSubElement.visible =
          v > 0 && me._page_down_bg.userData.visible;
      }
    ...
    me._page_down_bg.logicBlock_scaling = function () {
      var newLogicStateScaling;
      if (me.elementMouseOver["page_down_bg"] == true) {
        newLogicStateScaling = 0;
      } else {
        newLogicStateScaling = -1;
      }
      if (me._page_down_bg.ggCurrentLogicStateScaling != newLogicStateScaling) {
        ...
        if (me._page_down_bg.ggCurrentLogicStateScaling == 0) {
          me._page_down_bg.userData.transitionValue_scale = {
            x: 1.2,
            y: 1.2,
            z: 1.0,
          };
          for (
            var i = 0;
            i < me._page_down_bg.userData.transitions.length;
            i++
          ) {
          ...
          transition_scale.interval = setInterval(() => {
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._page_down_bg.scale.set(
              transition_scale.startScale.x +
                (me._page_down_bg.userData.transitionValue_scale.x -
                  transition_scale.startScale.x) *
                  tfval,
              transition_scale.startScale.y +
                (me._page_down_bg.userData.transitionValue_scale.y -
                  transition_scale.startScale.y) *
                  tfval,
              1.0
            );
            var scaleOffX = 0;
            var scaleOffY = 0;
            me._page_down_bg.position.x =
              me._page_down_bg.position.x -
              me._page_down_bg.userData.curScaleOffX +
              scaleOffX;
            me._page_down_bg.userData.curScaleOffX = scaleOffX;
            me._page_down_bg.position.y =
              me._page_down_bg.position.y -
              me._page_down_bg.userData.curScaleOffY +
              scaleOffY;
            me._page_down_bg.userData.curScaleOffY = scaleOffY;
            if (percentDone >= 1.0) {
              clearInterval(transition_scale.interval);
              me._page_down_bg.userData.transitions.splice(
                me._page_down_bg.userData.transitions.indexOf(transition_scale),
                1
              );
            }
          }, 20);
    ...
    me._page_down_bg.logicBlock_visible = function () {
      var newLogicStateVisible;
      if (player.getVariableValue("node_cloner_vr_hasDown") == true) {
        newLogicStateVisible = 0;
      } else {
        newLogicStateVisible = -1;
      }
      if (me._page_down_bg.ggCurrentLogicStateVisible != newLogicStateVisible) {
        ...
        if (me._page_down_bg.ggCurrentLogicStateVisible == 0) {
          me._page_down_bg.visible =
            (!me._page_down_bg.material &&
              Number(me._page_down_bg.userData.opacity > 0)) ||
            Number(me._page_down_bg.material.opacity) > 0
              ? true
              : false;
    ...
    el.userData.borderColorAlpha = 1;
    el.userData.setOpacityInternal = function (v) {
      me._exit_vr.material.opacity =
        v * me._exit_vr.userData.backgroundColorAlpha;
      if (me._exit_vr.userData.ggSubElement) {
        me._exit_vr.userData.ggSubElement.material.opacity = v;
        me._exit_vr.userData.ggSubElement.visible =
          v > 0 && me._exit_vr.userData.visible;
      }
    ...
    me._exit_vr.logicBlock_scaling = function () {
      var newLogicStateScaling;
      if (me.elementMouseOver["exit_vr"] == true) {
        newLogicStateScaling = 0;
      } else {
        newLogicStateScaling = -1;
      }
      if (me._exit_vr.ggCurrentLogicStateScaling != newLogicStateScaling) {
        ...
        if (me._exit_vr.ggCurrentLogicStateScaling == 0) {
          me._exit_vr.userData.transitionValue_scale = {
            x: 1.2,
            y: 1.2,
            z: 1.0,
          };
          ...
          transition_scale.interval = setInterval(() => {
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._exit_vr.scale.set(
              transition_scale.startScale.x +
                (me._exit_vr.userData.transitionValue_scale.x -
                  transition_scale.startScale.x) *
                  tfval,
              transition_scale.startScale.y +
                (me._exit_vr.userData.transitionValue_scale.y -
                  transition_scale.startScale.y) *
                  tfval,
              1.0
            );
            var scaleOffX = 0;
            var scaleOffY = 0;
            me._exit_vr.position.x =
              me._exit_vr.position.x -
              me._exit_vr.userData.curScaleOffX +
              scaleOffX;
            me._exit_vr.userData.curScaleOffX = scaleOffX;
            me._exit_vr.position.y =
              me._exit_vr.position.y -
              me._exit_vr.userData.curScaleOffY +
              scaleOffY;
            me._exit_vr.userData.curScaleOffY = scaleOffY;
            if (percentDone >= 1.0) {
              clearInterval(transition_scale.interval);
              me._exit_vr.userData.transitions.splice(
                me._exit_vr.userData.transitions.indexOf(transition_scale),
                1
              );
            }
          }, 20);
    ...
    el.userData.borderColorAlpha = 1;
    el.userData.setOpacityInternal = function (v) {
      me._close_skin.material.opacity =
        v * me._close_skin.userData.backgroundColorAlpha;
      if (me._close_skin.userData.ggSubElement) {
        me._close_skin.userData.ggSubElement.material.opacity = v;
        me._close_skin.userData.ggSubElement.visible =
          v > 0 && me._close_skin.userData.visible;
      }
    ...
    me._close_skin.logicBlock_scaling = function () {
      var newLogicStateScaling;
      if (me.elementMouseOver["close_skin"] == true) {
        newLogicStateScaling = 0;
      } else {
        newLogicStateScaling = -1;
      }
      if (me._close_skin.ggCurrentLogicStateScaling != newLogicStateScaling) {
        ...
        if (me._close_skin.ggCurrentLogicStateScaling == 0) {
          me._close_skin.userData.transitionValue_scale = {
            x: 1.2,
            y: 1.2,
            z: 1.0,
          };
          ...
          transition_scale.interval = setInterval(() => {
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._close_skin.scale.set(
              transition_scale.startScale.x +
                (me._close_skin.userData.transitionValue_scale.x -
                  transition_scale.startScale.x) *
                  tfval,
              transition_scale.startScale.y +
                (me._close_skin.userData.transitionValue_scale.y -
                  transition_scale.startScale.y) *
                  tfval,
              1.0
            );
            var scaleOffX = 0;
            var scaleOffY = 0;
            me._close_skin.position.x =
              me._close_skin.position.x -
              me._close_skin.userData.curScaleOffX +
              scaleOffX;
            me._close_skin.userData.curScaleOffX = scaleOffX;
            me._close_skin.position.y =
              me._close_skin.position.y -
              me._close_skin.userData.curScaleOffY +
              scaleOffY;
            me._close_skin.userData.curScaleOffY = scaleOffY;
            if (percentDone >= 1.0) {
              clearInterval(transition_scale.interval);
              me._close_skin.userData.transitions.splice(
                me._close_skin.userData.transitions.indexOf(transition_scale),
                1
              );
            }
          }, 20);
    ...
    el.userData.setOpacityInternal = function (v) {
      if (me._close_skin_icon.material)
        me._close_skin_icon.material.opacity = v;
      me._close_skin_icon.visible =
        v > 0 && me._close_skin_icon.userData.visible;
    };
    el.userData.isVisible = function () {
    ...
    el.userData.borderColorAlpha = 1;
    el.userData.setOpacityInternal = function (v) {
      me._open_skin.material.opacity =
        v * me._open_skin.userData.backgroundColorAlpha;
      if (me._open_skin.userData.ggSubElement) {
        me._open_skin.userData.ggSubElement.material.opacity = v;
        me._open_skin.userData.ggSubElement.visible =
          v > 0 && me._open_skin.userData.visible;
      }
    ...
    me._open_skin.logicBlock_scaling = function () {
      var newLogicStateScaling;
      if (me.elementMouseOver["open_skin"] == true) {
        newLogicStateScaling = 0;
      } else {
        newLogicStateScaling = -1;
      }
      if (me._open_skin.ggCurrentLogicStateScaling != newLogicStateScaling) {
        ...
        if (me._open_skin.ggCurrentLogicStateScaling == 0) {
          me._open_skin.userData.transitionValue_scale = {
            x: 1.2,
            y: 1.2,
            z: 1.0,
          };
          ...
          transition_scale.interval = setInterval(() => {
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._open_skin.scale.set(
              transition_scale.startScale.x +
                (me._open_skin.userData.transitionValue_scale.x -
                  transition_scale.startScale.x) *
                  tfval,
              transition_scale.startScale.y +
                (me._open_skin.userData.transitionValue_scale.y -
                  transition_scale.startScale.y) *
                  tfval,
              1.0
            );
            var scaleOffX = 0;
            var scaleOffY = 0;
            me._open_skin.position.x =
              me._open_skin.position.x -
              me._open_skin.userData.curScaleOffX +
              scaleOffX;
            me._open_skin.userData.curScaleOffX = scaleOffX;
            me._open_skin.position.y =
              me._open_skin.position.y -
              me._open_skin.userData.curScaleOffY +
              scaleOffY;
            me._open_skin.userData.curScaleOffY = scaleOffY;
            if (percentDone >= 1.0) {
              clearInterval(transition_scale.interval);
              me._open_skin.userData.transitions.splice(
                me._open_skin.userData.transitions.indexOf(transition_scale),
                1
              );
            }
          }, 20);
    ...
    me._thumbnails.logicBlock_visible();
    me._thumbnails.userData.setOpacity(1.0);
    me._node_cloner_vr.userData.setOpacity(1.0);
    me._node_cloner_vr.userData.ggUpdate();
    me._page_up_bg.logicBlock_scaling();
    me._page_up_bg.logicBlock_visible();
    me._page_up_bg.userData.setOpacity(1.0);
    me.elementMouseOver["page_up_bg"] = false;
    me._page_up.userData.setOpacity(1.0);
    me._page_down_bg.logicBlock_scaling();
    me._page_down_bg.logicBlock_visible();
    me._page_down_bg.userData.setOpacity(1.0);
    me.elementMouseOver["page_down_bg"] = false;
    me._page_down.userData.setOpacity(1.0);
    me._exit_vr.logicBlock_scaling();
    me._exit_vr.userData.setOpacity(1.0);
    me.elementMouseOver["exit_vr"] = false;
    me._exit_vr_icon.userData.setOpacity(1.0);
    me._close_skin.logicBlock_scaling();
    me._close_skin.userData.setOpacity(1.0);
    me.elementMouseOver["close_skin"] = false;
    me._close_skin_icon.userData.setOpacity(1.0);
    me._open_skin.logicBlock_scaling();
    me._open_skin.userData.setOpacity(1.0);
    me.elementMouseOver["open_skin"] = false;
    me._open_skin_icon.userData.setOpacity(1.0);
    me.eventactivehotspotchangedCallback = function () {
      for (var i = 0; i < me._node_cloner_vr.userData.ggInstances.length; i++) {
        me._node_cloner_vr.userData.ggInstances[
          i
        ].ggEvent_activehotspotchanged();
      }
    ...
    player.addListener(
      ...
      me.eventactivehotspotchangedCallback
    );
    ...
    player.addListener(
      "varchanged_node_cloner_vr_hasDown",
      me.eventvarchanged_node_cloner_vr_hasDownCallback
    );
    me.eventvarchanged_node_cloner_vr_hasUpCallback = function () {
      me._page_up_bg.logicBlock_visible();
    };
    player.addListener(
      "varchanged_node_cloner_vr_hasUp",
      me.eventvarchanged_node_cloner_vr_hasUpCallback
    );
    ...
    player.addListener(
      "varchanged_open_image_hs",
      me.eventvarchanged_open_image_hsCallback
    );
    ...
    player.addListener(
      "varchanged_open_info_hs",
      me.eventvarchanged_open_info_hsCallback
    );
    me.eventvarchanged_open_video_hsCallback = function () {
      if (hotspotTemplates.hasOwnProperty("ht_video_file")) {
        for (var i = 0; i < hotspotTemplates["ht_video_file"].length; i++) {
          hotspotTemplates["ht_video_file"][
            i
          ].ggEvent_varchanged_open_video_hs();
        }
      }
      if (hotspotTemplates.hasOwnProperty("ht_video_url")) {
        for (var i = 0; i < hotspotTemplates["ht_video_url"].length; i++) {
          hotspotTemplates["ht_video_url"][
            i
          ].ggEvent_varchanged_open_video_hs();
        }
      }
    ...
    player.addListener(
      "varchanged_open_video_hs",
      me.eventvarchanged_open_video_hsCallback
    );
  };
  this.removeSkin = function () {};
  function SkinCloner_node_cloner_vr_Class(
    nodeId,
    parentScope,
    ggParent,
    parameter
    ...
    texture = loader.load(
      basePath + "images_vr/node_image_" + nodeId + ".webp"
    );
    texture.colorSpace = player.getVRTextureColorSpace();
    material = new THREE.MeshBasicMaterial({
      map: texture,
    ...
    me._node_image.logicBlock_scaling = function () {
      var newLogicStateScaling;
      if (me.elementMouseOver["node_image"] == true) {
        newLogicStateScaling = 0;
      } else {
        newLogicStateScaling = -1;
      }
      if (me._node_image.ggCurrentLogicStateScaling != newLogicStateScaling) {
        ...
        if (me._node_image.ggCurrentLogicStateScaling == 0) {
          me._node_image.userData.transitionValue_scale = {
            x: 1,
            y: 1,
            z: 1.0,
          };
          ...
          transition_scale.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            let percentDone =
              (1.0 * (currentTime - transition_scale.startTime)) / 500;
            percentDone = Math.max(percentDone, 0.0);
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._node_image.scale.set(
              transition_scale.startScale.x +
                (me._node_image.userData.transitionValue_scale.x -
                  transition_scale.startScale.x) *
                  tfval,
              transition_scale.startScale.y +
                (me._node_image.userData.transitionValue_scale.y -
                  transition_scale.startScale.y) *
                  tfval,
              1.0
            );
            var scaleOffX = 0;
            var scaleOffY = 0;
            me._node_image.position.x =
              me._node_image.position.x -
              me._node_image.userData.curScaleOffX +
              scaleOffX;
            me._node_image.userData.curScaleOffX = scaleOffX;
            me._node_image.position.y =
              me._node_image.position.y -
              me._node_image.userData.curScaleOffY +
              scaleOffY;
            me._node_image.userData.curScaleOffY = scaleOffY;
            if (percentDone >= 1.0) {
              clearInterval(transition_scale.interval);
              me._node_image.userData.transitions.splice(
                me._node_image.userData.transitions.indexOf(transition_scale),
                1
              );
            }
          }, 20);
    ...
    el.userData.setOpacityInternal = function (v) {
      ...
      if (me._node_title.userData.ggSubElement) {
        ...
        me._node_title.userData.ggSubElement.visible =
          v > 0 && me._node_title.userData.visible;
      }
    ...
    el.visible = true;
    el.userData.visible = true;
    el.userData.opacity = 0.0;
    el.userData.parentOpacity = 1.0;
    el.userData.transitions = [];
    me._node_title = el;
    el.userData.textLines = [];
    el.userData.backgroundColor = new THREE.Color(
      0,
      0,
      0
    ).convertSRGBToLinear();
    el.userData.textColor = new THREE.Color(
      0.760784,
      0.909804,
      0.0705882
    ).convertSRGBToLinear();
    ...
    el.userData.ggWrapText = function (scrollbar) {
      ...
      for (var i = 0; i < words.length; i++) {
        if (words[i] == "\n") {
          ...
          line = "";
          me._node_title.userData.totalHeightCanv +=
            me._node_title.userData.lineHeightCanv;
          continue;
        }
        var testLine;
        if (line == "") {
        ...
        if (
          testWidth >
            2 * (me._node_title.userData.width - 10 - (scrollbar ? 25 : 0)) &&
          i > 0
        ) {
          me._node_title.userData.textLines.push(line);
          line = words[i];
    ...
    el.userData.ggPaintCanvasText = function () {
      ...
      ctx.fillStyle =
        "rgba(" +
        me._node_title.userData.backgroundColor.r * 255 +
        ", " +
        me._node_title.userData.backgroundColor.g * 255 +
        ", " +
        me._node_title.userData.backgroundColor.b * 255 +
        ", " +
        me._node_title.userData.backgroundColorAlpha +
        ")";
      ctx.fillRect(0, 0, canv.width, canv.height);
      ctx.fillStyle =
        "rgba(" +
        me._node_title.userData.textColor.r * 255 +
        ", " +
        me._node_title.userData.textColor.g * 255 +
        ", " +
        me._node_title.userData.textColor.b * 255 +
        ", " +
        me._node_title.userData.textColorAlpha +
        ")";
      ctx.textBaseline = "top";
      var x =
        (me._node_title.userData.boxWidthCanv -
          (me._node_title.userData.hasScrollbar ? 50 : 0)) /
        2;
    ...
    el.userData.ggRenderText = function () {
      ...
      me._node_title.userData.boxHeightCanv =
        2 * me._node_title.userData.height;
    ...
    me._node_title.logicBlock_alpha = function () {
      ...
      if (me._node_title.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
        ...
        if (me._node_title.ggCurrentLogicStateAlpha == 0) {
          ...
          transition_alpha.startAlpha = me._node_title.material
            ? me._node_title.material.opacity
            : me._node_title.userData.opacity;
          transition_alpha.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            let percentDone =
              (1.0 * (currentTime - transition_alpha.startTime)) / 300;
            percentDone = Math.max(percentDone, 0.0);
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._node_title.userData.setOpacity(
              transition_alpha.startAlpha +
                (me._node_title.userData.transitionValue_alpha -
                  transition_alpha.startAlpha) *
                  tfval
            );
            if (percentDone >= 1.0) {
              clearInterval(transition_alpha.interval);
              me._node_title.userData.transitions.splice(
                me._node_title.userData.transitions.indexOf(transition_alpha),
                1
              );
            }
          }, 20);
    ...
    me._node_image.logicBlock_scaling();
    me._node_image.userData.setOpacity(1.0);
    me.elementMouseOver["node_image"] = false;
    me._node_title.logicBlock_alpha();
    me._node_title.userData.setOpacity(0.0);
  ...
  function SkinHotspotClass_ht_video_url(parentScope, hotspot) {
    ...
    el.userData.borderColorAlpha = 1;
    el.userData.setOpacityInternal = function (v) {
      me._ht_video_url_bg.material.opacity =
        v * me._ht_video_url_bg.userData.backgroundColorAlpha;
      if (me._ht_video_url_bg.userData.ggSubElement) {
        me._ht_video_url_bg.userData.ggSubElement.material.opacity = v;
        me._ht_video_url_bg.userData.ggSubElement.visible =
          v > 0 && me._ht_video_url_bg.userData.visible;
      }
      me._ht_video_url_bg.visible =
        v > 0 && me._ht_video_url_bg.userData.visible;
    };
    el.userData.setBackgroundColor = function (v) {
    ...
    el.userData.setBackgroundColorAlpha = function (v) {
      ...
      me._ht_video_url_bg.userData.setOpacity(
        me._ht_video_url_bg.userData.opacity
      );
    };
    el.translateX(0);
    el.translateY(0);
    ...
    me._ht_video_url_bg.logicBlock_scaling = function () {
      var newLogicStateScaling;
      if (me.elementMouseOver["ht_video_url_bg"] == true) {
        newLogicStateScaling = 0;
      } else {
        newLogicStateScaling = -1;
      }
      if (
        ...
        if (me._ht_video_url_bg.ggCurrentLogicStateScaling == 0) {
          me._ht_video_url_bg.userData.transitionValue_scale = {
            x: 1.2,
            y: 1.2,
            z: 1.0,
          };
          for (
            var i = 0;
            i < me._ht_video_url_bg.userData.transitions.length;
            i++
          ) {
            if (
              me._ht_video_url_bg.userData.transitions[i].property == "scale"
            ) {
              clearInterval(
                me._ht_video_url_bg.userData.transitions[i].interval
              );
          ...
          transition_scale.property = "scale";
          transition_scale.startTime = Date.now();
          transition_scale.startScale = structuredClone(
            me._ht_video_url_bg.scale
          );
          transition_scale.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            let percentDone =
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._ht_video_url_bg.scale.set(
              transition_scale.startScale.x +
                (me._ht_video_url_bg.userData.transitionValue_scale.x -
                  transition_scale.startScale.x) *
                  tfval,
              transition_scale.startScale.y +
                (me._ht_video_url_bg.userData.transitionValue_scale.y -
                  transition_scale.startScale.y) *
                  tfval,
              1.0
            );
            var scaleOffX = 0;
            var scaleOffY = 0;
            me._ht_video_url_bg.position.x =
              me._ht_video_url_bg.position.x -
              me._ht_video_url_bg.userData.curScaleOffX +
              scaleOffX;
            me._ht_video_url_bg.userData.curScaleOffX = scaleOffX;
            me._ht_video_url_bg.position.y =
              me._ht_video_url_bg.position.y -
              me._ht_video_url_bg.userData.curScaleOffY +
              scaleOffY;
            me._ht_video_url_bg.userData.curScaleOffY = scaleOffY;
            if (percentDone >= 1.0) {
              clearInterval(transition_scale.interval);
              me._ht_video_url_bg.userData.transitions.splice(
                me._ht_video_url_bg.userData.transitions.indexOf(
                  transition_scale
                ),
                1
              );
    ...
    me._ht_video_url_bg.logicBlock_visible = function () {
      ...
      if (
        ...
        if (me._ht_video_url_bg.ggCurrentLogicStateVisible == 0) {
          me._ht_video_url_bg.visible =
            (!me._ht_video_url_bg.material &&
              Number(me._ht_video_url_bg.userData.opacity > 0)) ||
            Number(me._ht_video_url_bg.material.opacity) > 0
              ? true
              : false;
    ...
    me._ht_video_url_bg.logicBlock_alpha = function () {
      var newLogicStateAlpha;
      if (
        player.getVariableValue("open_video_hs") !== null &&
        player
          .getVariableValue("open_video_hs")
          .indexOf("<" + me.hotspot.id + ">") != -1
      ) {
        newLogicStateAlpha = 0;
      } else {
        newLogicStateAlpha = -1;
      ...
      if (me._ht_video_url_bg.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
        ...
        if (me._ht_video_url_bg.ggCurrentLogicStateAlpha == 0) {
          ...
          for (
            ...
            if (
              me._ht_video_url_bg.userData.transitions[i].property == "alpha"
            ) {
              clearInterval(
                me._ht_video_url_bg.userData.transitions[i].interval
              );
          ...
          transition_alpha.property = "alpha";
          transition_alpha.startTime = Date.now();
          transition_alpha.startAlpha = me._ht_video_url_bg.material
            ? me._ht_video_url_bg.material.opacity
            : me._ht_video_url_bg.userData.opacity;
          transition_alpha.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            let percentDone =
              (1.0 * (currentTime - transition_alpha.startTime)) / 200;
            percentDone = Math.max(percentDone, 0.0);
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._ht_video_url_bg.userData.setOpacity(
              transition_alpha.startAlpha +
                (me._ht_video_url_bg.userData.transitionValue_alpha -
                  transition_alpha.startAlpha) *
                  tfval
            );
            if (percentDone >= 1.0) {
    ...
    me._ht_video_url_bg.userData.onclick = function (e) {
      player.setVariableValue(
        "open_video_hs",
        player.getVariableValue("open_video_hs") + "<" + me.hotspot.id + ">"
      );
    ...
    el.userData.setOpacityInternal = function (v) {
      ...
      me._ht_video_url_icon.visible =
        v > 0 && me._ht_video_url_icon.userData.visible;
    };
    el.userData.isVisible = function () {
    ...
    me._ht_video_url_icon.userData.ggUpdatePosition = function (
      useTransition
    ) {};
    ...
    el.userData.setOpacityInternal = function (v) {
      ...
      if (me._ht_video_url_title.userData.ggSubElement) {
        ...
        me._ht_video_url_title.userData.ggSubElement.visible =
          v > 0 && me._ht_video_url_title.userData.visible;
      }
      me._ht_video_url_title.visible =
        v > 0 && me._ht_video_url_title.userData.visible;
    };
    el.userData.setBackgroundColor = function (v) {
    ...
    el.userData.setBackgroundColorAlpha = function (v) {
      ...
      me._ht_video_url_title.userData.setOpacity(
        me._ht_video_url_title.userData.opacity
      );
    };
    el.translateX(0);
    el.translateY(-0.325);
    ...
    el.userData.ggWrapText = function (scrollbar) {
      ...
      for (var i = 0; i < words.length; i++) {
        if (words[i] == "\n") {
          ...
          line = "";
          me._ht_video_url_title.userData.totalHeightCanv +=
            me._ht_video_url_title.userData.lineHeightCanv;
          continue;
        }
        var testLine;
        if (line == "") {
        ...
        if (
          testWidth >
            2 *
              (me._ht_video_url_title.userData.width -
                0 -
                (scrollbar ? 25 : 0)) &&
          i > 0
        ) {
    ...
    el.userData.ggPaintCanvasText = function () {
      ...
      ctx.fillStyle =
        "rgba(" +
        me._ht_video_url_title.userData.textColor.r * 255 +
        ", " +
        me._ht_video_url_title.userData.textColor.g * 255 +
        ", " +
        me._ht_video_url_title.userData.textColor.b * 255 +
        ", " +
        me._ht_video_url_title.userData.textColorAlpha +
        ")";
      ctx.textBaseline = "top";
      var x =
        (me._ht_video_url_title.userData.boxWidthCanv -
          (me._ht_video_url_title.userData.hasScrollbar ? 50 : 0)) /
        2;
      ctx.textAlign = "center";
      var y = 2 * 3;
      for (
        var i = 0;
        i < me._ht_video_url_title.userData.textLines.length;
        i++
      ) {
      ...
      geometry = new THREE.PlaneGeometry(
        me._ht_video_url_title.userData.boxWidthCanv / 200.0,
        me._ht_video_url_title.userData.boxHeightCanv / 200.0,
        5,
        5
      );
      geometry.name = "ht_video_url_title_geometry";
      ...
      var diffY =
        me._ht_video_url_title.userData.boxHeightCanv / 2 -
        me._ht_video_url_title.userData.height;
      me._ht_video_url_title.position.y =
        me._ht_video_url_title.userData.y - diffY / 2.0 / 100.0;
      var textTexture = new THREE.CanvasTexture(canv);
    ...
    el.userData.ggRenderText = function () {
      for (let i = 0; i < me._ht_video_url_title.children.length; i++) {
        let child = me._ht_video_url_title.children[i];
        if (child.name.includes("scrollbar"))
          me._ht_video_url_title.remove(child);
      }
      var canv = me._ht_video_url_title.userData.textCanvas;
      var ctx = me._ht_video_url_title.userData.textCanvasContext;
      ...
      me._ht_video_url_title.userData.textLines = [];
      me._ht_video_url_title.userData.textLines.push(
        me._ht_video_url_title.userData.ggText
      );
      me._ht_video_url_title.userData.totalHeightCanv = 2 * 3;
      me._ht_video_url_title.userData.totalHeightCanv +=
        me._ht_video_url_title.userData.lineHeightCanv;
      me._ht_video_url_title.userData.boxWidthCanv =
        ctx.measureText(me._ht_video_url_title.userData.ggText).width + 2 * 0;
      me._ht_video_url_title.userData.boxHeightCanv =
        me._ht_video_url_title.userData.totalHeightCanv;
    ...
    me._ht_video_url_title.logicBlock_alpha = function () {
      ...
      if (
        ...
        if (me._ht_video_url_title.ggCurrentLogicStateAlpha == 0) {
          ...
          for (
            var i = 0;
            i < me._ht_video_url_title.userData.transitions.length;
            i++
          ) {
            if (
              me._ht_video_url_title.userData.transitions[i].property == "alpha"
            ) {
              clearInterval(
                me._ht_video_url_title.userData.transitions[i].interval
              );
          ...
          transition_alpha.property = "alpha";
          transition_alpha.startTime = Date.now();
          transition_alpha.startAlpha = me._ht_video_url_title.material
            ? me._ht_video_url_title.material.opacity
            : me._ht_video_url_title.userData.opacity;
          transition_alpha.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            let percentDone =
            ...
            me._ht_video_url_title.userData.setOpacity(
              transition_alpha.startAlpha +
                (me._ht_video_url_title.userData.transitionValue_alpha -
                  transition_alpha.startAlpha) *
                  tfval
            );
            if (percentDone >= 1.0) {
              clearInterval(transition_alpha.interval);
              me._ht_video_url_title.userData.transitions.splice(
                me._ht_video_url_title.userData.transitions.indexOf(
                  transition_alpha
                ),
                1
              );
    ...
    me._ht_video_url_title.logicBlock_alpha();
    me._ht_video_url_title.userData.ggUpdatePosition = function (
      useTransition
    ) {};
    ...
    el.userData.borderColorAlpha = 1;
    el.userData.setOpacityInternal = function (v) {
      me._ht_video_url_popup_bg.material.opacity =
        v * me._ht_video_url_popup_bg.userData.backgroundColorAlpha;
      if (me._ht_video_url_popup_bg.userData.ggSubElement) {
        me._ht_video_url_popup_bg.userData.ggSubElement.material.opacity = v;
        me._ht_video_url_popup_bg.userData.ggSubElement.visible =
          v > 0 && me._ht_video_url_popup_bg.userData.visible;
      }
      me._ht_video_url_popup_bg.visible =
        v > 0 && me._ht_video_url_popup_bg.userData.visible;
    };
    el.userData.setBackgroundColor = function (v) {
    ...
    el.userData.setBackgroundColorAlpha = function (v) {
      ...
      me._ht_video_url_popup_bg.userData.setOpacity(
        me._ht_video_url_popup_bg.userData.opacity
      );
    };
    el.translateX(0);
    el.translateY(0);
    el.scale.set(0.1, 0.1, 1.0);
    el.userData.width = 660;
    el.userData.height = 480;
    el.userData.scale = { x: 0.1, y: 0.1, z: 1.0 };
    el.userData.curScaleOffX = 0;
    el.userData.curScaleOffY = 0;
    ...
    me._ht_video_url_popup_bg.logicBlock_scaling = function () {
      ...
      if (
        me._ht_video_url_popup_bg.ggCurrentLogicStateScaling !=
        newLogicStateScaling
      ) {
        me._ht_video_url_popup_bg.ggCurrentLogicStateScaling =
          newLogicStateScaling;
        if (me._ht_video_url_popup_bg.ggCurrentLogicStateScaling == 0) {
          me._ht_video_url_popup_bg.userData.transitionValue_scale = {
            x: 1,
            y: 1,
            z: 1.0,
          };
          for (
            var i = 0;
            i < me._ht_video_url_popup_bg.userData.transitions.length;
            i++
          ) {
            if (
              me._ht_video_url_popup_bg.userData.transitions[i].property ==
              "scale"
            ) {
              clearInterval(
                me._ht_video_url_popup_bg.userData.transitions[i].interval
              );
          ...
          transition_scale.startTime = Date.now();
          transition_scale.startScale = structuredClone(
            me._ht_video_url_popup_bg.scale
          );
          transition_scale.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            let percentDone =
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._ht_video_url_popup_bg.scale.set(
              transition_scale.startScale.x +
                (me._ht_video_url_popup_bg.userData.transitionValue_scale.x -
                  transition_scale.startScale.x) *
                  tfval,
              transition_scale.startScale.y +
                (me._ht_video_url_popup_bg.userData.transitionValue_scale.y -
                  transition_scale.startScale.y) *
                  tfval,
              1.0
            );
            var scaleOffX = 0;
            var scaleOffY = 0;
            me._ht_video_url_popup_bg.position.x =
              me._ht_video_url_popup_bg.position.x -
              me._ht_video_url_popup_bg.userData.curScaleOffX +
              scaleOffX;
            me._ht_video_url_popup_bg.userData.curScaleOffX = scaleOffX;
            me._ht_video_url_popup_bg.position.y =
              me._ht_video_url_popup_bg.position.y -
              me._ht_video_url_popup_bg.userData.curScaleOffY +
              scaleOffY;
            me._ht_video_url_popup_bg.userData.curScaleOffY = scaleOffY;
            if (percentDone >= 1.0) {
              clearInterval(transition_scale.interval);
              me._ht_video_url_popup_bg.userData.transitions.splice(
                me._ht_video_url_popup_bg.userData.transitions.indexOf(
                  transition_scale
                ),
                1
              );
    ...
    me._ht_video_url_popup_bg.logicBlock_alpha = function () {
      ...
      if (
        ...
        if (me._ht_video_url_popup_bg.ggCurrentLogicStateAlpha == 0) {
          ...
          transition_alpha.property = "alpha";
          transition_alpha.startTime = Date.now();
          transition_alpha.startAlpha = me._ht_video_url_popup_bg.material
            ? me._ht_video_url_popup_bg.material.opacity
            : me._ht_video_url_popup_bg.userData.opacity;
          transition_alpha.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            let percentDone =
              (1.0 * (currentTime - transition_alpha.startTime)) / 500;
            percentDone = Math.max(percentDone, 0.0);
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._ht_video_url_popup_bg.userData.setOpacity(
              transition_alpha.startAlpha +
                (me._ht_video_url_popup_bg.userData.transitionValue_alpha -
                  transition_alpha.startAlpha) *
                  tfval
            );
            if (percentDone >= 1.0) {
    ...
    me._ht_video_url_popup_bg.userData.ggUpdatePosition = function (
      useTransition
    ) {};
    ...
    el.userData.setOpacityInternal = function (v) {
      if (me._ht_video_url_popup.material)
        me._ht_video_url_popup.material.opacity = v;
      me._ht_video_url_popup.visible =
        v > 0 && me._ht_video_url_popup.userData.visible;
    };
    el.userData.isVisible = function () {
    ...
    me._ht_video_url_popup.userData.ggInitMedia = function (media) {
      ...
      player.registerVideoElement(
        "ht_video_url_popup",
        me._ht_video_url_popup__vid
      );
      ...
      me._ht_video_url_popup__vid.addEventListener(
        "loadedmetadata",
        function () {
          let videoAR =
            me._ht_video_url_popup__vid.videoWidth /
            me._ht_video_url_popup__vid.videoHeight;
          let elAR =
            me._ht_video_url_popup.userData.width /
            me._ht_video_url_popup.userData.height;
          if (videoAR > elAR) {
            me._ht_video_url_popup.scale.set(
              1,
              me._ht_video_url_popup.userData.width /
                videoAR /
                me._ht_video_url_popup.userData.height,
            ...
            me._ht_video_url_popup.scale.set(
              (me._ht_video_url_popup.userData.height * videoAR) /
                me._ht_video_url_popup.userData.width,
              1,
              1
            );
    ...
    me._ht_video_url_popup.userData.ggIsActive = function () {
      if (me._ht_video_url_popup__vid != null) {
        return (
          me._ht_video_url_popup__vid.paused == false &&
          me._ht_video_url_popup__vid.ended == false
        );
      } else {
        return false;
      }
    ...
    me._ht_video_url_popup.logicBlock_visible = function () {
      ...
      if (
        me._ht_video_url_popup.ggCurrentLogicStateVisible !=
        ...
        if (me._ht_video_url_popup.ggCurrentLogicStateVisible == 0) {
          me._ht_video_url_popup.visible =
            (!me._ht_video_url_popup.material &&
              Number(me._ht_video_url_popup.userData.opacity > 0)) ||
            Number(me._ht_video_url_popup.material.opacity) > 0
              ? true
              : false;
          ...
          if (me._ht_video_url_popup.userData.ggVideoNotLoaded) {
            me._ht_video_url_popup.userData.ggInitMedia(
              me._ht_video_url_popup.ggVideoSource
            );
          }
        } else {
    ...
    me._ht_video_url_popup.userData.ggUpdatePosition = function (
      useTransition
    ) {};
    ...
    el.userData.setOpacityInternal = function (v) {
      if (me._ht_video_url_popup_close.material)
        me._ht_video_url_popup_close.material.opacity = v;
      me._ht_video_url_popup_close.visible =
        v > 0 && me._ht_video_url_popup_close.userData.visible;
    };
    el.userData.isVisible = function () {
    ...
    el.userData.materialOver = new THREE.MeshBasicMaterial({
      map: textureOver,
      side: THREE.DoubleSide,
      transparent: true,
    });
    ...
    me._ht_video_url_popup_close.userData.onclick = function (e) {
      player.setVariableValue(
        ...
        player
          .getVariableValue("open_video_hs")
          .replace("<" + me.hotspot.id + ">", "")
      );
    };
    me._ht_video_url_popup_close.userData.onmouseenter = function (e) {
      me._ht_video_url_popup_close.material =
        me._ht_video_url_popup_close.userData.materialOver;
      me.elementMouseOver["ht_video_url_popup_close"] = true;
    };
    me._ht_video_url_popup_close.userData.onmouseleave = function (e) {
      me._ht_video_url_popup_close.material =
        me._ht_video_url_popup_close.userData.materialNormal;
      me.elementMouseOver["ht_video_url_popup_close"] = false;
    };
    me._ht_video_url_popup_close.userData.ggUpdatePosition = function (
      useTransition
    ) {};
    ...
    el.userData.setOpacityInternal = function (v) {
      if (me._ht_video_url_customimage.userData.ggSubElement) {
        ...
        me._ht_video_url_customimage.userData.ggSubElement.visible =
          v > 0 && me._ht_video_url_customimage.userData.visible;
      }
      me._ht_video_url_customimage.visible =
        v > 0 && me._ht_video_url_customimage.userData.visible;
    };
    el.translateX(0);
    el.translateY(0);
    ...
    currentHeight = 50;
    var img = {};
    img.geometry = new THREE.PlaneGeometry(
      currentWidth / 100.0,
      currentHeight / 100.0,
      5,
      5
    ...
    el.userData.ggSetUrl = function (extUrl) {
      loader.load(extUrl, function (texture) {
        texture.colorSpace = player.getVRTextureColorSpace();
        var loadedMaterial = new THREE.MeshBasicMaterial({
          map: texture,
          side: THREE.DoubleSide,
          transparent: true,
        });
        loadedMaterial.name = "ht_video_url_CustomImage_subElementMaterial";
        me._ht_video_url_customimage.userData.ggSubElement.material =
          loadedMaterial;
        me._ht_video_url_customimage.userData.ggUpdatePosition();
        me._ht_video_url_customimage.userData.ggText = extUrl;
        me._ht_video_url_customimage.userData.setOpacity(
          me._ht_video_url_customimage.userData.opacity
        );
      });
    };
    ...
    me._ht_video_url_customimage.logicBlock_visible = function () {
      ...
      if (
        me._ht_video_url_customimage.ggCurrentLogicStateVisible !=
        newLogicStateVisible
      ) {
        me._ht_video_url_customimage.ggCurrentLogicStateVisible =
          newLogicStateVisible;
        if (me._ht_video_url_customimage.ggCurrentLogicStateVisible == 0) {
          ...
          me._ht_video_url_customimage.visible =
            (!me._ht_video_url_customimage.material &&
              Number(me._ht_video_url_customimage.userData.opacity > 0)) ||
            Number(me._ht_video_url_customimage.material.opacity) > 0
              ? true
              : false;
    ...
    me._ht_video_url_customimage.userData.ggUpdatePosition = function (
      useTransition
    ) {
    ...
    me._ht_video_url.userData.setOpacity(1.0);
    me.elementMouseOver["ht_video_url"] = false;
    me._ht_video_url_bg.logicBlock_scaling();
    me._ht_video_url_bg.logicBlock_visible();
    me._ht_video_url_bg.logicBlock_alpha();
    me._ht_video_url_bg.userData.setOpacity(1.0);
    me.elementMouseOver["ht_video_url_bg"] = false;
    me._ht_video_url_icon.userData.setOpacity(1.0);
    me._ht_video_url_title.logicBlock_alpha();
    me._ht_video_url_title.userData.setOpacity(0.0);
    me._ht_video_url_popup_bg.logicBlock_scaling();
    me._ht_video_url_popup_bg.logicBlock_alpha();
    me._ht_video_url_popup_bg.userData.setOpacity(0.0);
    me._ht_video_url_popup.logicBlock_visible();
    me._ht_video_url_popup.userData.setOpacity(1.0);
    me._ht_video_url_popup.userData.ggVideoSource = "";
    me._ht_video_url_popup.userData.ggVideoNotLoaded = true;
    me._ht_video_url_popup_close.userData.setOpacity(1.0);
    me.elementMouseOver["ht_video_url_popup_close"] = false;
    me._ht_video_url_customimage.logicBlock_visible();
    me._ht_video_url_customimage.userData.setOpacity(1.0);
    me.ggEvent_activehotspotchanged = function () {
      me._ht_video_url_bg.logicBlock_visible();
      me._ht_video_url_customimage.logicBlock_visible();
    };
  ...
  function SkinHotspotClass_ht_video_file(parentScope, hotspot) {
    ...
    el.userData.borderColorAlpha = 1;
    el.userData.setOpacityInternal = function (v) {
      me._ht_video_file_bg.material.opacity =
        v * me._ht_video_file_bg.userData.backgroundColorAlpha;
      if (me._ht_video_file_bg.userData.ggSubElement) {
        me._ht_video_file_bg.userData.ggSubElement.material.opacity = v;
        me._ht_video_file_bg.userData.ggSubElement.visible =
          v > 0 && me._ht_video_file_bg.userData.visible;
      }
      me._ht_video_file_bg.visible =
        v > 0 && me._ht_video_file_bg.userData.visible;
    };
    el.userData.setBackgroundColor = function (v) {
    ...
    el.userData.setBackgroundColorAlpha = function (v) {
      ...
      me._ht_video_file_bg.userData.setOpacity(
        me._ht_video_file_bg.userData.opacity
      );
    };
    el.translateX(0);
    el.translateY(0);
    ...
    me._ht_video_file_bg.logicBlock_scaling = function () {
      var newLogicStateScaling;
      if (me.elementMouseOver["ht_video_file_bg"] == true) {
        newLogicStateScaling = 0;
      } else {
        newLogicStateScaling = -1;
      }
      if (
        ...
        if (me._ht_video_file_bg.ggCurrentLogicStateScaling == 0) {
          me._ht_video_file_bg.userData.transitionValue_scale = {
            x: 1.2,
            y: 1.2,
            z: 1.0,
          };
          for (
            var i = 0;
            i < me._ht_video_file_bg.userData.transitions.length;
            i++
          ) {
            if (
              me._ht_video_file_bg.userData.transitions[i].property == "scale"
            ) {
              clearInterval(
                me._ht_video_file_bg.userData.transitions[i].interval
              );
          ...
          transition_scale.interval = setInterval(() => {
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._ht_video_file_bg.scale.set(
              transition_scale.startScale.x +
                (me._ht_video_file_bg.userData.transitionValue_scale.x -
                  transition_scale.startScale.x) *
                  tfval,
              transition_scale.startScale.y +
                (me._ht_video_file_bg.userData.transitionValue_scale.y -
                  transition_scale.startScale.y) *
                  tfval,
              1.0
            );
            var scaleOffX = 0;
            var scaleOffY = 0;
            me._ht_video_file_bg.position.x =
              me._ht_video_file_bg.position.x -
              me._ht_video_file_bg.userData.curScaleOffX +
              scaleOffX;
            me._ht_video_file_bg.userData.curScaleOffX = scaleOffX;
            me._ht_video_file_bg.position.y =
              me._ht_video_file_bg.position.y -
              me._ht_video_file_bg.userData.curScaleOffY +
              scaleOffY;
            me._ht_video_file_bg.userData.curScaleOffY = scaleOffY;
            if (percentDone >= 1.0) {
              clearInterval(transition_scale.interval);
              me._ht_video_file_bg.userData.transitions.splice(
                me._ht_video_file_bg.userData.transitions.indexOf(
                  transition_scale
                ),
                1
              );
    ...
    me._ht_video_file_bg.logicBlock_visible = function () {
      ...
      if (
        ...
        if (me._ht_video_file_bg.ggCurrentLogicStateVisible == 0) {
          me._ht_video_file_bg.visible =
            (!me._ht_video_file_bg.material &&
              Number(me._ht_video_file_bg.userData.opacity > 0)) ||
            Number(me._ht_video_file_bg.material.opacity) > 0
              ? true
              : false;
      ...
      if (me._ht_video_file_bg.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
        ...
        if (me._ht_video_file_bg.ggCurrentLogicStateAlpha == 0) {
          ...
          for (
            ...
            if (
              me._ht_video_file_bg.userData.transitions[i].property == "alpha"
            ) {
              clearInterval(
                me._ht_video_file_bg.userData.transitions[i].interval
              );
          ...
          transition_alpha.property = "alpha";
          transition_alpha.startTime = Date.now();
          transition_alpha.startAlpha = me._ht_video_file_bg.material
            ? me._ht_video_file_bg.material.opacity
            : me._ht_video_file_bg.userData.opacity;
          transition_alpha.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            ...
            me._ht_video_file_bg.userData.setOpacity(
              transition_alpha.startAlpha +
                (me._ht_video_file_bg.userData.transitionValue_alpha -
                  transition_alpha.startAlpha) *
                  tfval
            );
            if (percentDone >= 1.0) {
    ...
    me._ht_video_file_bg.userData.ggUpdatePosition = function (
      useTransition
    ) {};
    geometry = new THREE.PlaneGeometry(0.36, 0.36, 5, 5);
    ...
    el.userData.setOpacityInternal = function (v) {
      ...
      me._ht_video_file_icon.visible =
        v > 0 && me._ht_video_file_icon.userData.visible;
    };
    el.userData.isVisible = function () {
    ...
    me._ht_video_file_icon.userData.ggUpdatePosition = function (
      useTransition
    ) {};
    ...
    el.userData.setOpacityInternal = function (v) {
      ...
      if (me._ht_video_file_title.userData.ggSubElement) {
        ...
        me._ht_video_file_title.userData.ggSubElement.visible =
          v > 0 && me._ht_video_file_title.userData.visible;
      }
      me._ht_video_file_title.visible =
        v > 0 && me._ht_video_file_title.userData.visible;
    };
    el.userData.setBackgroundColor = function (v) {
    ...
    el.userData.setBackgroundColorAlpha = function (v) {
      ...
      me._ht_video_file_title.userData.setOpacity(
        me._ht_video_file_title.userData.opacity
      );
    };
    el.translateX(0);
    el.translateY(-0.325);
    ...
    el.userData.ggWrapText = function (scrollbar) {
      ...
      for (var i = 0; i < words.length; i++) {
        if (words[i] == "\n") {
          ...
          line = "";
          me._ht_video_file_title.userData.totalHeightCanv +=
            me._ht_video_file_title.userData.lineHeightCanv;
          continue;
        }
        var testLine;
        if (line == "") {
        ...
        if (
          testWidth >
            2 *
              (me._ht_video_file_title.userData.width -
                0 -
                (scrollbar ? 25 : 0)) &&
          i > 0
        ) {
    ...
    el.userData.ggPaintCanvasText = function () {
      ...
      ctx.fillStyle =
        "rgba(" +
        me._ht_video_file_title.userData.textColor.r * 255 +
        ", " +
        me._ht_video_file_title.userData.textColor.g * 255 +
        ", " +
        me._ht_video_file_title.userData.textColor.b * 255 +
        ", " +
        me._ht_video_file_title.userData.textColorAlpha +
        ")";
      ctx.textBaseline = "top";
      var x =
        (me._ht_video_file_title.userData.boxWidthCanv -
          (me._ht_video_file_title.userData.hasScrollbar ? 50 : 0)) /
        2;
      ctx.textAlign = "center";
      var y = 2 * 3;
      for (
        var i = 0;
        i < me._ht_video_file_title.userData.textLines.length;
        i++
      ) {
      ...
      geometry = new THREE.PlaneGeometry(
        me._ht_video_file_title.userData.boxWidthCanv / 200.0,
        me._ht_video_file_title.userData.boxHeightCanv / 200.0,
        5,
        5
      );
      geometry.name = "ht_video_file_title_geometry";
      ...
      var diffY =
        me._ht_video_file_title.userData.boxHeightCanv / 2 -
        me._ht_video_file_title.userData.height;
      me._ht_video_file_title.position.y =
        me._ht_video_file_title.userData.y - diffY / 2.0 / 100.0;
      var textTexture = new THREE.CanvasTexture(canv);
    ...
    el.userData.ggRenderText = function () {
      for (let i = 0; i < me._ht_video_file_title.children.length; i++) {
        let child = me._ht_video_file_title.children[i];
        if (child.name.includes("scrollbar"))
          me._ht_video_file_title.remove(child);
      }
      var canv = me._ht_video_file_title.userData.textCanvas;
      var ctx = me._ht_video_file_title.userData.textCanvasContext;
      ctx.font = "36px Verdana";
      ...
      me._ht_video_file_title.userData.textLines = [];
      me._ht_video_file_title.userData.textLines.push(
        me._ht_video_file_title.userData.ggText
      );
      me._ht_video_file_title.userData.totalHeightCanv = 2 * 3;
      me._ht_video_file_title.userData.totalHeightCanv +=
        me._ht_video_file_title.userData.lineHeightCanv;
      me._ht_video_file_title.userData.boxWidthCanv =
        ctx.measureText(me._ht_video_file_title.userData.ggText).width + 2 * 0;
      me._ht_video_file_title.userData.boxHeightCanv =
        me._ht_video_file_title.userData.totalHeightCanv;
    ...
    me._ht_video_file_title.logicBlock_alpha = function () {
      ...
      if (
        ...
        if (me._ht_video_file_title.ggCurrentLogicStateAlpha == 0) {
          ...
          for (
            var i = 0;
            i < me._ht_video_file_title.userData.transitions.length;
            i++
          ) {
            if (
              me._ht_video_file_title.userData.transitions[i].property ==
              "alpha"
            ) {
              clearInterval(
                me._ht_video_file_title.userData.transitions[i].interval
              );
          ...
          transition_alpha.property = "alpha";
          transition_alpha.startTime = Date.now();
          transition_alpha.startAlpha = me._ht_video_file_title.material
            ? me._ht_video_file_title.material.opacity
            : me._ht_video_file_title.userData.opacity;
          transition_alpha.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            let percentDone =
            ...
            me._ht_video_file_title.userData.setOpacity(
              transition_alpha.startAlpha +
                (me._ht_video_file_title.userData.transitionValue_alpha -
                  transition_alpha.startAlpha) *
                  tfval
            );
            if (percentDone >= 1.0) {
              clearInterval(transition_alpha.interval);
              me._ht_video_file_title.userData.transitions.splice(
                me._ht_video_file_title.userData.transitions.indexOf(
                  transition_alpha
                ),
                1
              );
    ...
    me._ht_video_file_title.logicBlock_alpha();
    me._ht_video_file_title.userData.ggUpdatePosition = function (
      useTransition
    ) {};
    ...
    el.userData.borderColorAlpha = 1;
    el.userData.setOpacityInternal = function (v) {
      me._ht_video_file_popup_bg.material.opacity =
        v * me._ht_video_file_popup_bg.userData.backgroundColorAlpha;
      if (me._ht_video_file_popup_bg.userData.ggSubElement) {
        me._ht_video_file_popup_bg.userData.ggSubElement.material.opacity = v;
        me._ht_video_file_popup_bg.userData.ggSubElement.visible =
          v > 0 && me._ht_video_file_popup_bg.userData.visible;
      }
      me._ht_video_file_popup_bg.visible =
        v > 0 && me._ht_video_file_popup_bg.userData.visible;
    };
    el.userData.setBackgroundColor = function (v) {
    ...
    el.userData.setBackgroundColorAlpha = function (v) {
      ...
      me._ht_video_file_popup_bg.userData.setOpacity(
        me._ht_video_file_popup_bg.userData.opacity
      );
    };
    el.translateX(0);
    el.translateY(0);
    ...
    me._ht_video_file_popup_bg.logicBlock_scaling = function () {
      ...
      if (
        me._ht_video_file_popup_bg.ggCurrentLogicStateScaling !=
        newLogicStateScaling
      ) {
        me._ht_video_file_popup_bg.ggCurrentLogicStateScaling =
          newLogicStateScaling;
        if (me._ht_video_file_popup_bg.ggCurrentLogicStateScaling == 0) {
          me._ht_video_file_popup_bg.userData.transitionValue_scale = {
            x: 1,
            y: 1,
            z: 1.0,
          };
          for (
            var i = 0;
            i < me._ht_video_file_popup_bg.userData.transitions.length;
            i++
          ) {
            if (
              me._ht_video_file_popup_bg.userData.transitions[i].property ==
              "scale"
            ) {
              clearInterval(
                me._ht_video_file_popup_bg.userData.transitions[i].interval
              );
          ...
          transition_scale.startTime = Date.now();
          transition_scale.startScale = structuredClone(
            me._ht_video_file_popup_bg.scale
          );
          transition_scale.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            let percentDone =
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._ht_video_file_popup_bg.scale.set(
              transition_scale.startScale.x +
                (me._ht_video_file_popup_bg.userData.transitionValue_scale.x -
                  transition_scale.startScale.x) *
                  tfval,
              transition_scale.startScale.y +
                (me._ht_video_file_popup_bg.userData.transitionValue_scale.y -
                  transition_scale.startScale.y) *
                  tfval,
              1.0
            );
            var scaleOffX = 0;
            var scaleOffY = 0;
            me._ht_video_file_popup_bg.position.x =
              me._ht_video_file_popup_bg.position.x -
              me._ht_video_file_popup_bg.userData.curScaleOffX +
              scaleOffX;
            me._ht_video_file_popup_bg.userData.curScaleOffX = scaleOffX;
            me._ht_video_file_popup_bg.position.y =
              me._ht_video_file_popup_bg.position.y -
              me._ht_video_file_popup_bg.userData.curScaleOffY +
              scaleOffY;
            me._ht_video_file_popup_bg.userData.curScaleOffY = scaleOffY;
            if (percentDone >= 1.0) {
              clearInterval(transition_scale.interval);
              me._ht_video_file_popup_bg.userData.transitions.splice(
                me._ht_video_file_popup_bg.userData.transitions.indexOf(
                  transition_scale
                ),
                1
              );
          ...
          me._ht_video_file_popup_bg.userData.transitions.push(
            transition_scale
          );
        } else {
          me._ht_video_file_popup_bg.userData.transitionValue_scale = {
    ...
    me._ht_video_file_popup_bg.logicBlock_alpha = function () {
      ...
      if (
        me._ht_video_file_popup_bg.ggCurrentLogicStateAlpha !=
        newLogicStateAlpha
      ) {
        me._ht_video_file_popup_bg.ggCurrentLogicStateAlpha =
          newLogicStateAlpha;
        if (me._ht_video_file_popup_bg.ggCurrentLogicStateAlpha == 0) {
          ...
          transition_alpha.property = "alpha";
          transition_alpha.startTime = Date.now();
          transition_alpha.startAlpha = me._ht_video_file_popup_bg.material
            ? me._ht_video_file_popup_bg.material.opacity
            : me._ht_video_file_popup_bg.userData.opacity;
          transition_alpha.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            ...
            me._ht_video_file_popup_bg.userData.setOpacity(
              transition_alpha.startAlpha +
                (me._ht_video_file_popup_bg.userData.transitionValue_alpha -
                  transition_alpha.startAlpha) *
                  tfval
            );
            if (percentDone >= 1.0) {
    ...
    me._ht_video_file_popup_bg.userData.ggUpdatePosition = function (
      useTransition
    ) {};
    geometry = new THREE.PlaneGeometry(6, 3.8, 5, 5);
    ...
    el.userData.setOpacityInternal = function (v) {
      if (me._ht_video_file_popup.material)
        me._ht_video_file_popup.material.opacity = v;
      me._ht_video_file_popup.visible =
        v > 0 && me._ht_video_file_popup.userData.visible;
    };
    el.userData.isVisible = function () {
    ...
    me._ht_video_file_popup.userData.ggInitMedia = function (media) {
      ...
      me._ht_video_file_popup__vid.addEventListener(
        "loadedmetadata",
        function () {
          let videoAR =
            me._ht_video_file_popup__vid.videoWidth /
            me._ht_video_file_popup__vid.videoHeight;
          let elAR =
            me._ht_video_file_popup.userData.width /
            me._ht_video_file_popup.userData.height;
          if (videoAR > elAR) {
            me._ht_video_file_popup.scale.set(
              1,
              me._ht_video_file_popup.userData.width /
                videoAR /
                me._ht_video_file_popup.userData.height,
            ...
            me._ht_video_file_popup.scale.set(
              (me._ht_video_file_popup.userData.height * videoAR) /
                me._ht_video_file_popup.userData.width,
              1,
              1
            );
    ...
    me._ht_video_file_popup.userData.ggIsActive = function () {
      if (me._ht_video_file_popup__vid != null) {
        return (
          me._ht_video_file_popup__vid.paused == false &&
          me._ht_video_file_popup__vid.ended == false
        );
      } else {
        return false;
      }
    ...
    me._ht_video_file_popup.logicBlock_visible = function () {
      ...
      if (
        me._ht_video_file_popup.ggCurrentLogicStateVisible !=
        newLogicStateVisible
      ) {
        me._ht_video_file_popup.ggCurrentLogicStateVisible =
          newLogicStateVisible;
        if (me._ht_video_file_popup.ggCurrentLogicStateVisible == 0) {
          me._ht_video_file_popup.visible =
            (!me._ht_video_file_popup.material &&
              Number(me._ht_video_file_popup.userData.opacity > 0)) ||
            Number(me._ht_video_file_popup.material.opacity) > 0
              ? true
              : false;
          ...
          if (me._ht_video_file_popup.userData.ggVideoNotLoaded) {
            me._ht_video_file_popup.userData.ggInitMedia(
              me._ht_video_file_popup.ggVideoSource
            );
          }
        } else {
    ...
    me._ht_video_file_popup.userData.ggUpdatePosition = function (
      useTransition
    ) {};
    ...
    el.userData.setOpacityInternal = function (v) {
      if (me._ht_video_file_popup_close.material)
        me._ht_video_file_popup_close.material.opacity = v;
      me._ht_video_file_popup_close.visible =
        v > 0 && me._ht_video_file_popup_close.userData.visible;
    };
    el.userData.isVisible = function () {
    ...
    me._ht_video_file_popup_close.userData.onmouseenter = function (e) {
      me._ht_video_file_popup_close.material =
        me._ht_video_file_popup_close.userData.materialOver;
      me.elementMouseOver["ht_video_file_popup_close"] = true;
    };
    me._ht_video_file_popup_close.userData.onmouseleave = function (e) {
      me._ht_video_file_popup_close.material =
        me._ht_video_file_popup_close.userData.materialNormal;
      me.elementMouseOver["ht_video_file_popup_close"] = false;
    };
    me._ht_video_file_popup_close.userData.ggUpdatePosition = function (
      useTransition
    ) {};
    ...
    el.userData.setOpacityInternal = function (v) {
      if (me._ht_video_file_customimage.userData.ggSubElement) {
        me._ht_video_file_customimage.userData.ggSubElement.material.opacity =
          v;
        me._ht_video_file_customimage.userData.ggSubElement.visible =
          v > 0 && me._ht_video_file_customimage.userData.visible;
      }
      me._ht_video_file_customimage.visible =
        v > 0 && me._ht_video_file_customimage.userData.visible;
    };
    el.translateX(0);
    el.translateY(0);
    ...
    el.userData.ggSetUrl = function (extUrl) {
      loader.load(extUrl, function (texture) {
        ...
        me._ht_video_file_customimage.userData.ggSubElement.material =
          loadedMaterial;
        me._ht_video_file_customimage.userData.ggUpdatePosition();
        me._ht_video_file_customimage.userData.ggText = extUrl;
        me._ht_video_file_customimage.userData.setOpacity(
          me._ht_video_file_customimage.userData.opacity
        );
      });
    };
    if (hotspot && hotspot.customimage) {
    ...
    me._ht_video_file_customimage.logicBlock_visible = function () {
      ...
      if (
        me._ht_video_file_customimage.ggCurrentLogicStateVisible !=
        newLogicStateVisible
      ) {
        me._ht_video_file_customimage.ggCurrentLogicStateVisible =
          newLogicStateVisible;
        if (me._ht_video_file_customimage.ggCurrentLogicStateVisible == 0) {
          ...
          me._ht_video_file_customimage.visible =
            (!me._ht_video_file_customimage.material &&
              Number(me._ht_video_file_customimage.userData.opacity > 0)) ||
            Number(me._ht_video_file_customimage.material.opacity) > 0
              ? true
              : false;
    ...
    me._ht_video_file_customimage.userData.ggUpdatePosition = function (
      useTransition
    ) {
    ...
    me._ht_video_file.userData.setOpacity(1.0);
    me.elementMouseOver["ht_video_file"] = false;
    me._ht_video_file_bg.logicBlock_scaling();
    me._ht_video_file_bg.logicBlock_visible();
    me._ht_video_file_bg.logicBlock_alpha();
    me._ht_video_file_bg.userData.setOpacity(1.0);
    me.elementMouseOver["ht_video_file_bg"] = false;
    me._ht_video_file_icon.userData.setOpacity(1.0);
    me._ht_video_file_title.logicBlock_alpha();
    me._ht_video_file_title.userData.setOpacity(0.0);
    me._ht_video_file_popup_bg.logicBlock_scaling();
    me._ht_video_file_popup_bg.logicBlock_alpha();
    me._ht_video_file_popup_bg.userData.setOpacity(0.0);
    me._ht_video_file_popup.logicBlock_visible();
    me._ht_video_file_popup.userData.setOpacity(1.0);
    me._ht_video_file_popup.userData.ggVideoSource = "media_vr/";
    me._ht_video_file_popup.userData.ggVideoNotLoaded = true;
    me._ht_video_file_popup_close.userData.setOpacity(1.0);
    me.elementMouseOver["ht_video_file_popup_close"] = false;
    me._ht_video_file_customimage.logicBlock_visible();
    me._ht_video_file_customimage.userData.setOpacity(1.0);
    me.ggEvent_activehotspotchanged = function () {
      me._ht_video_file_bg.logicBlock_visible();
      me._ht_video_file_customimage.logicBlock_visible();
    };
  ...
  function SkinHotspotClass_ht_info(parentScope, hotspot) {
    ...
    el.userData.borderColorAlpha = 1;
    el.userData.setOpacityInternal = function (v) {
      me._ht_info_bg.material.opacity =
        v * me._ht_info_bg.userData.backgroundColorAlpha;
      if (me._ht_info_bg.userData.ggSubElement) {
        me._ht_info_bg.userData.ggSubElement.material.opacity = v;
        me._ht_info_bg.userData.ggSubElement.visible =
          v > 0 && me._ht_info_bg.userData.visible;
      }
    ...
    me._ht_info_bg.logicBlock_scaling = function () {
      var newLogicStateScaling;
      if (me.elementMouseOver["ht_info_bg"] == true) {
        newLogicStateScaling = 0;
      } else {
        newLogicStateScaling = -1;
      }
      if (me._ht_info_bg.ggCurrentLogicStateScaling != newLogicStateScaling) {
        ...
        if (me._ht_info_bg.ggCurrentLogicStateScaling == 0) {
          me._ht_info_bg.userData.transitionValue_scale = {
            x: 1.2,
            y: 1.2,
            z: 1.0,
          };
          ...
          transition_scale.interval = setInterval(() => {
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._ht_info_bg.scale.set(
              transition_scale.startScale.x +
                (me._ht_info_bg.userData.transitionValue_scale.x -
                  transition_scale.startScale.x) *
                  tfval,
              transition_scale.startScale.y +
                (me._ht_info_bg.userData.transitionValue_scale.y -
                  transition_scale.startScale.y) *
                  tfval,
              1.0
            );
            var scaleOffX = 0;
            var scaleOffY = 0;
            me._ht_info_bg.position.x =
              me._ht_info_bg.position.x -
              me._ht_info_bg.userData.curScaleOffX +
              scaleOffX;
            me._ht_info_bg.userData.curScaleOffX = scaleOffX;
            me._ht_info_bg.position.y =
              me._ht_info_bg.position.y -
              me._ht_info_bg.userData.curScaleOffY +
              scaleOffY;
            me._ht_info_bg.userData.curScaleOffY = scaleOffY;
            if (percentDone >= 1.0) {
              clearInterval(transition_scale.interval);
              me._ht_info_bg.userData.transitions.splice(
                me._ht_info_bg.userData.transitions.indexOf(transition_scale),
                1
              );
            }
          }, 20);
    ...
    me._ht_info_bg.logicBlock_visible = function () {
      ...
      if (me._ht_info_bg.ggCurrentLogicStateVisible != newLogicStateVisible) {
        ...
        if (me._ht_info_bg.ggCurrentLogicStateVisible == 0) {
          me._ht_info_bg.visible =
            (!me._ht_info_bg.material &&
              Number(me._ht_info_bg.userData.opacity > 0)) ||
            Number(me._ht_info_bg.material.opacity) > 0
              ? true
              : false;
    ...
    me._ht_info_bg.logicBlock_alpha = function () {
      var newLogicStateAlpha;
      if (
        player.getVariableValue("open_image_hs") !== null &&
        player
          .getVariableValue("open_image_hs")
          .indexOf("<" + me.hotspot.id + ">") != -1
      ) {
        newLogicStateAlpha = 0;
      } else {
      ...
      if (me._ht_info_bg.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
        ...
        if (me._ht_info_bg.ggCurrentLogicStateAlpha == 0) {
          ...
          transition_alpha.property = "alpha";
          transition_alpha.startTime = Date.now();
          transition_alpha.startAlpha = me._ht_info_bg.material
            ? me._ht_info_bg.material.opacity
            : me._ht_info_bg.userData.opacity;
          transition_alpha.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            let percentDone =
              (1.0 * (currentTime - transition_alpha.startTime)) / 200;
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._ht_info_bg.userData.setOpacity(
              transition_alpha.startAlpha +
                (me._ht_info_bg.userData.transitionValue_alpha -
                  transition_alpha.startAlpha) *
                  tfval
            );
            if (percentDone >= 1.0) {
              clearInterval(transition_alpha.interval);
              me._ht_info_bg.userData.transitions.splice(
                me._ht_info_bg.userData.transitions.indexOf(transition_alpha),
                1
              );
            }
          }, 20);
    ...
    me._ht_info_bg.userData.onclick = function (e) {
      player.setVariableValue(
        "open_info_hs",
        player.getVariableValue("open_info_hs") + "<" + me.hotspot.id + ">"
      );
    };
    ...
    el.userData.setOpacityInternal = function (v) {
      ...
      if (me._ht_info_title.userData.ggSubElement) {
        ...
        me._ht_info_title.userData.ggSubElement.visible =
          v > 0 && me._ht_info_title.userData.visible;
      }
    ...
    el.userData.ggWrapText = function (scrollbar) {
      ...
      for (var i = 0; i < words.length; i++) {
        if (words[i] == "\n") {
          ...
          line = "";
          me._ht_info_title.userData.totalHeightCanv +=
            me._ht_info_title.userData.lineHeightCanv;
          continue;
        }
        var testLine;
        if (line == "") {
        ...
        if (
          testWidth >
            2 * (me._ht_info_title.userData.width - 0 - (scrollbar ? 25 : 0)) &&
          i > 0
        ) {
          me._ht_info_title.userData.textLines.push(line);
          line = words[i];
    ...
    el.userData.ggPaintCanvasText = function () {
      ...
      ctx.fillStyle =
        "rgba(" +
        me._ht_info_title.userData.textColor.r * 255 +
        ", " +
        me._ht_info_title.userData.textColor.g * 255 +
        ", " +
        me._ht_info_title.userData.textColor.b * 255 +
        ", " +
        me._ht_info_title.userData.textColorAlpha +
        ")";
      ctx.textBaseline = "top";
      var x =
        (me._ht_info_title.userData.boxWidthCanv -
          (me._ht_info_title.userData.hasScrollbar ? 50 : 0)) /
        2;
      ctx.textAlign = "center";
      var y = 2 * 3;
      ...
      geometry = new THREE.PlaneGeometry(
        me._ht_info_title.userData.boxWidthCanv / 200.0,
        me._ht_info_title.userData.boxHeightCanv / 200.0,
        5,
        5
      );
      geometry.name = "ht_info_title_geometry";
      ...
      var diffY =
        me._ht_info_title.userData.boxHeightCanv / 2 -
        me._ht_info_title.userData.height;
      me._ht_info_title.position.y =
        me._ht_info_title.userData.y - diffY / 2.0 / 100.0;
      var textTexture = new THREE.CanvasTexture(canv);
    ...
    el.userData.ggRenderText = function () {
      ...
      me._ht_info_title.userData.textLines = [];
      me._ht_info_title.userData.textLines.push(
        me._ht_info_title.userData.ggText
      );
      me._ht_info_title.userData.totalHeightCanv = 2 * 3;
      me._ht_info_title.userData.totalHeightCanv +=
        me._ht_info_title.userData.lineHeightCanv;
      me._ht_info_title.userData.boxWidthCanv =
        ctx.measureText(me._ht_info_title.userData.ggText).width + 2 * 0;
      me._ht_info_title.userData.boxHeightCanv =
        me._ht_info_title.userData.totalHeightCanv;
    ...
    me._ht_info_title.logicBlock_alpha = function () {
      ...
      if (me._ht_info_title.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
        ...
        if (me._ht_info_title.ggCurrentLogicStateAlpha == 0) {
          ...
          for (
            var i = 0;
            i < me._ht_info_title.userData.transitions.length;
            i++
          ) {
          ...
          transition_alpha.property = "alpha";
          transition_alpha.startTime = Date.now();
          transition_alpha.startAlpha = me._ht_info_title.material
            ? me._ht_info_title.material.opacity
            : me._ht_info_title.userData.opacity;
          transition_alpha.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            let percentDone =
              (1.0 * (currentTime - transition_alpha.startTime)) / 300;
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._ht_info_title.userData.setOpacity(
              transition_alpha.startAlpha +
                (me._ht_info_title.userData.transitionValue_alpha -
                  transition_alpha.startAlpha) *
                  tfval
            );
            if (percentDone >= 1.0) {
              clearInterval(transition_alpha.interval);
              me._ht_info_title.userData.transitions.splice(
                me._ht_info_title.userData.transitions.indexOf(
                  transition_alpha
                ),
                1
              );
    ...
    el.userData.borderColorAlpha = 1;
    el.userData.setOpacityInternal = function (v) {
      me._ht_info_popup_bg.material.opacity =
        v * me._ht_info_popup_bg.userData.backgroundColorAlpha;
      if (me._ht_info_popup_bg.userData.ggSubElement) {
        me._ht_info_popup_bg.userData.ggSubElement.material.opacity = v;
        me._ht_info_popup_bg.userData.ggSubElement.visible =
          v > 0 && me._ht_info_popup_bg.userData.visible;
      }
      me._ht_info_popup_bg.visible =
        v > 0 && me._ht_info_popup_bg.userData.visible;
    };
    el.userData.setBackgroundColor = function (v) {
    ...
    el.userData.setBackgroundColorAlpha = function (v) {
      ...
      me._ht_info_popup_bg.userData.setOpacity(
        me._ht_info_popup_bg.userData.opacity
      );
    };
    el.translateX(0);
    el.translateY(0);
    ...
    me._ht_info_popup_bg.logicBlock_scaling = function () {
      var newLogicStateScaling;
      if (
        player.getVariableValue("open_info_hs") !== null &&
        player
          .getVariableValue("open_info_hs")
          .indexOf("<" + me.hotspot.id + ">") != -1
      ) {
        newLogicStateScaling = 0;
      } else {
      ...
      if (
        ...
        if (me._ht_info_popup_bg.ggCurrentLogicStateScaling == 0) {
          me._ht_info_popup_bg.userData.transitionValue_scale = {
            x: 1,
            y: 1,
            z: 1.0,
          };
          for (
            var i = 0;
            i < me._ht_info_popup_bg.userData.transitions.length;
            i++
          ) {
            if (
              me._ht_info_popup_bg.userData.transitions[i].property == "scale"
            ) {
              clearInterval(
                me._ht_info_popup_bg.userData.transitions[i].interval
              );
          ...
          transition_scale.interval = setInterval(() => {
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._ht_info_popup_bg.scale.set(
              transition_scale.startScale.x +
                (me._ht_info_popup_bg.userData.transitionValue_scale.x -
                  transition_scale.startScale.x) *
                  tfval,
              transition_scale.startScale.y +
                (me._ht_info_popup_bg.userData.transitionValue_scale.y -
                  transition_scale.startScale.y) *
                  tfval,
              1.0
            );
            var scaleOffX = 0;
            var scaleOffY = 0;
            me._ht_info_popup_bg.position.x =
              me._ht_info_popup_bg.position.x -
              me._ht_info_popup_bg.userData.curScaleOffX +
              scaleOffX;
            me._ht_info_popup_bg.userData.curScaleOffX = scaleOffX;
            me._ht_info_popup_bg.position.y =
              me._ht_info_popup_bg.position.y -
              me._ht_info_popup_bg.userData.curScaleOffY +
              scaleOffY;
            me._ht_info_popup_bg.userData.curScaleOffY = scaleOffY;
            if (percentDone >= 1.0) {
              clearInterval(transition_scale.interval);
              me._ht_info_popup_bg.userData.transitions.splice(
                me._ht_info_popup_bg.userData.transitions.indexOf(
                  transition_scale
                ),
                1
              );
      ...
      if (me._ht_info_popup_bg.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
        ...
        if (me._ht_info_popup_bg.ggCurrentLogicStateAlpha == 0) {
          ...
          for (
            ...
            if (
              me._ht_info_popup_bg.userData.transitions[i].property == "alpha"
            ) {
              clearInterval(
                me._ht_info_popup_bg.userData.transitions[i].interval
              );
          ...
          transition_alpha.property = "alpha";
          transition_alpha.startTime = Date.now();
          transition_alpha.startAlpha = me._ht_info_popup_bg.material
            ? me._ht_info_popup_bg.material.opacity
            : me._ht_info_popup_bg.userData.opacity;
          transition_alpha.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            ...
            me._ht_info_popup_bg.userData.setOpacity(
              transition_alpha.startAlpha +
                (me._ht_info_popup_bg.userData.transitionValue_alpha -
                  transition_alpha.startAlpha) *
                  tfval
            );
            if (percentDone >= 1.0) {
    ...
    me._ht_info_popup_bg.userData.ggUpdatePosition = function (
      useTransition
    ) {};
    ...
    el.userData.setOpacityInternal = function (v) {
      ...
      if (me._ht_info_popup.userData.ggSubElement) {
        ...
        me._ht_info_popup.userData.ggSubElement.visible =
          v > 0 && me._ht_info_popup.userData.visible;
      }
    ...
    el.userData.ggWrapText = function (scrollbar) {
      ...
      for (var i = 0; i < words.length; i++) {
        if (words[i] == "\n") {
          ...
          line = "";
          me._ht_info_popup.userData.totalHeightCanv +=
            me._ht_info_popup.userData.lineHeightCanv;
          continue;
        }
        var testLine;
        if (line == "") {
        ...
        if (
          testWidth >
            2 *
              (me._ht_info_popup.userData.width - 30 - (scrollbar ? 25 : 0)) &&
          i > 0
        ) {
          me._ht_info_popup.userData.textLines.push(line);
          line = words[i];
    ...
    el.userData.ggPaintCanvasText = function () {
      ...
      ctx.fillStyle =
        "rgba(" +
        me._ht_info_popup.userData.backgroundColor.r * 255 +
        ", " +
        me._ht_info_popup.userData.backgroundColor.g * 255 +
        ", " +
        me._ht_info_popup.userData.backgroundColor.b * 255 +
        ", " +
        me._ht_info_popup.userData.backgroundColorAlpha +
        ")";
      ctx.fillRect(0, 0, canv.width, canv.height);
      ctx.fillStyle =
        "rgba(" +
        me._ht_info_popup.userData.textColor.r * 255 +
        ", " +
        me._ht_info_popup.userData.textColor.g * 255 +
        ", " +
        me._ht_info_popup.userData.textColor.b * 255 +
        ", " +
        me._ht_info_popup.userData.textColorAlpha +
        ")";
      ctx.textBaseline = "top";
      var x = 2 * 15;
      ctx.textAlign = "left";
      var y = 2 * 18;
      y -=
        me._ht_info_popup.userData.scrollPosPercent *
        me._ht_info_popup.userData.totalHeightCanv;
    ...
    el.userData.ggRenderText = function () {
      ...
      me._ht_info_popup.userData.boxWidthCanv =
        2 * me._ht_info_popup.userData.width;
      me._ht_info_popup.userData.boxHeightCanv =
        2 * me._ht_info_popup.userData.height;
      ...
      if (
        ...
        me._ht_info_popup.userData.pagePercent =
          (2 * me._ht_info_popup.userData.height -
            me._ht_info_popup.userData.lineHeightCanv) /
          me._ht_info_popup.userData.totalHeightCanv;
        me._ht_info_popup.userData.maxScrollPercent =
          (me._ht_info_popup.userData.totalHeightCanv -
            2 * me._ht_info_popup.userData.height) /
          me._ht_info_popup.userData.totalHeightCanv;
        geometry = new THREE.PlaneGeometry(
          25 / 100.0,
          me._ht_info_popup.userData.height / 100.0,
          5,
          5
        );
        ...
        me._ht_info_popup.userData.scrollbarBg = new THREE.Mesh(
          geometry,
          material
        );
        me._ht_info_popup.userData.scrollbarBg.name =
          "ht_info_popup_scrollbarBg";
        me._ht_info_popup.add(me._ht_info_popup.userData.scrollbarBg);
        me._ht_info_popup.userData.scrollbarXPos =
          (me._ht_info_popup.userData.width - 25) / 200.0;
        me._ht_info_popup.userData.scrollbarBg.position.x =
          me._ht_info_popup.userData.scrollbarXPos;
        me._ht_info_popup.userData.scrollbarBg.position.z =
          me._ht_info_popup.position.z + 0.01;
        me._ht_info_popup.userData.scrollbarBg.userData.stopPropagation = true;
        me._ht_info_popup.userData.scrollbarHeight =
          ((2 * me._ht_info_popup.userData.height) /
            me._ht_info_popup.userData.totalHeightCanv) *
          me._ht_info_popup.userData.height;
        geometry = new THREE.PlaneGeometry(
          25 / 100.0,
          me._ht_info_popup.userData.scrollbarHeight / 100.0,
          5,
          5
        );
        ...
        me._ht_info_popup.userData.scrollbar = new THREE.Mesh(
          geometry,
          material
        );
        ...
        me._ht_info_popup.userData.scrollbar.position.x =
          me._ht_info_popup.userData.scrollbarXPos;
        me._ht_info_popup.userData.scrollbar.position.z =
          me._ht_info_popup.position.z + 0.02;
        me._ht_info_popup.userData.scrollbarYPosMin =
          (me._ht_info_popup.userData.height -
            me._ht_info_popup.userData.scrollbarHeight) /
          200.0;
        me._ht_info_popup.userData.scrollbarYPosMax =
          me._ht_info_popup.userData.scrollbarYPosMin -
          (me._ht_info_popup.userData.height -
            me._ht_info_popup.userData.scrollbarHeight) /
            100.0;
        me._ht_info_popup.userData.scrollbar.position.y =
          me._ht_info_popup.userData.scrollbarYPosMin;
        geometry = new THREE.PlaneGeometry(
          25 / 100.0,
          me._ht_info_popup.userData.height / 200.0,
          5,
          5
        );
        ...
        me._ht_info_popup.userData.scrollbarPageDown = new THREE.Mesh(
          geometry,
          material
        );
        me._ht_info_popup.userData.scrollbarPageDown.name =
          "ht_info_popup_scrollbarPageDown";
        me._ht_info_popup.userData.scrollbarPageDown.userData.onclick =
          function () {
            me._ht_info_popup.userData.scrollPosPercent -=
              me._ht_info_popup.userData.pagePercent;
            me._ht_info_popup.userData.scrollPosPercent = Math.max(
              me._ht_info_popup.userData.scrollPosPercent,
              0
            );
            ...
            me._ht_info_popup.userData.scrollbar.position.y +=
              (me._ht_info_popup.userData.height *
                me._ht_info_popup.userData.pagePercent) /
              100.0;
            me._ht_info_popup.userData.scrollbar.position.y = Math.min(
              me._ht_info_popup.userData.scrollbar.position.y,
              me._ht_info_popup.userData.scrollbarYPosMin
            );
          };
        me._ht_info_popup.userData.scrollbarPageDown.position.x =
          me._ht_info_popup.userData.scrollbarXPos;
        me._ht_info_popup.userData.scrollbarPageDown.position.y =
          me._ht_info_popup.userData.height / 400.0;
        me._ht_info_popup.userData.scrollbarPageDown.position.z =
          me._ht_info_popup.position.z + 0.05;
        ...
        me._ht_info_popup.userData.scrollbarPageUp = new THREE.Mesh(
          geometry,
          material
        );
        me._ht_info_popup.userData.scrollbarPageUp.name =
          "ht_info_popup_scrollbarPageUp";
        me._ht_info_popup.userData.scrollbarPageUp.userData.onclick =
          function () {
            me._ht_info_popup.userData.scrollPosPercent +=
              me._ht_info_popup.userData.pagePercent;
            me._ht_info_popup.userData.scrollPosPercent = Math.min(
              me._ht_info_popup.userData.scrollPosPercent,
              me._ht_info_popup.userData.maxScrollPercent
            );
            me._ht_info_popup.userData.ggPaintCanvasText();
            me._ht_info_popup.userData.scrollbar.position.y -=
              (me._ht_info_popup.userData.height *
                me._ht_info_popup.userData.pagePercent) /
              100.0;
            me._ht_info_popup.userData.scrollbar.position.y = Math.max(
              me._ht_info_popup.userData.scrollbar.position.y,
              me._ht_info_popup.userData.scrollbarYPosMax
            );
          };
        me._ht_info_popup.userData.scrollbarPageUp.position.x =
          me._ht_info_popup.userData.scrollbarXPos;
        me._ht_info_popup.userData.scrollbarPageUp.position.y =
          -me._ht_info_popup.userData.height / 400.0;
        me._ht_info_popup.userData.scrollbarPageUp.position.z =
          me._ht_info_popup.position.z + 0.05;
    ...
    el.userData.setOpacityInternal = function (v) {
      if (me._ht_info_popup_close.material)
        me._ht_info_popup_close.material.opacity = v;
      me._ht_info_popup_close.visible =
        v > 0 && me._ht_info_popup_close.userData.visible;
    };
    el.userData.isVisible = function () {
    ...
    me._ht_info_popup_close.userData.onmouseenter = function (e) {
      me._ht_info_popup_close.material =
        me._ht_info_popup_close.userData.materialOver;
      me.elementMouseOver["ht_info_popup_close"] = true;
    };
    me._ht_info_popup_close.userData.onmouseleave = function (e) {
      me._ht_info_popup_close.material =
        me._ht_info_popup_close.userData.materialNormal;
      me.elementMouseOver["ht_info_popup_close"] = false;
    };
    me._ht_info_popup_close.userData.ggUpdatePosition = function (
      useTransition
    ) {};
    ...
    el.userData.setOpacityInternal = function (v) {
      if (me._ht_info_customimage.userData.ggSubElement) {
        ...
        me._ht_info_customimage.userData.ggSubElement.visible =
          v > 0 && me._ht_info_customimage.userData.visible;
      }
      me._ht_info_customimage.visible =
        v > 0 && me._ht_info_customimage.userData.visible;
    };
    el.translateX(0);
    el.translateY(0);
    ...
    el.userData.ggSetUrl = function (extUrl) {
      loader.load(extUrl, function (texture) {
        ...
        me._ht_info_customimage.userData.setOpacity(
          me._ht_info_customimage.userData.opacity
        );
      });
    };
    if (hotspot && hotspot.customimage) {
    ...
    me._ht_info_customimage.logicBlock_visible = function () {
      ...
      if (
        me._ht_info_customimage.ggCurrentLogicStateVisible !=
        newLogicStateVisible
      ) {
        me._ht_info_customimage.ggCurrentLogicStateVisible =
          newLogicStateVisible;
        if (me._ht_info_customimage.ggCurrentLogicStateVisible == 0) {
          ...
          me._ht_info_customimage.visible =
            (!me._ht_info_customimage.material &&
              Number(me._ht_info_customimage.userData.opacity > 0)) ||
            Number(me._ht_info_customimage.material.opacity) > 0
              ? true
              : false;
    ...
    me._ht_info_customimage.userData.ggUpdatePosition = function (
      useTransition
    ) {
    ...
    me._ht_info.userData.setOpacity(1.0);
    me.elementMouseOver["ht_info"] = false;
    me._ht_info_bg.logicBlock_scaling();
    me._ht_info_bg.logicBlock_visible();
    me._ht_info_bg.logicBlock_alpha();
    me._ht_info_bg.userData.setOpacity(1.0);
    me.elementMouseOver["ht_info_bg"] = false;
    me._ht_info_icon.userData.setOpacity(1.0);
    me._ht_info_title.logicBlock_alpha();
    me._ht_info_title.userData.setOpacity(0.0);
    me._ht_info_popup_bg.logicBlock_scaling();
    me._ht_info_popup_bg.logicBlock_alpha();
    me._ht_info_popup_bg.userData.setOpacity(0.0);
    me._ht_info_popup.userData.setOpacity(1.0);
    me._ht_info_popup_close.userData.setOpacity(1.0);
    me.elementMouseOver["ht_info_popup_close"] = false;
    me._ht_info_customimage.logicBlock_visible();
    me._ht_info_customimage.userData.setOpacity(1.0);
    me.ggEvent_activehotspotchanged = function () {
      me._ht_info_bg.logicBlock_visible();
      me._ht_info_customimage.logicBlock_visible();
    };
  ...
  function SkinHotspotClass_ht_image(parentScope, hotspot) {
    ...
    el.userData.borderColorAlpha = 1;
    el.userData.setOpacityInternal = function (v) {
      me._ht_image_bg.material.opacity =
        v * me._ht_image_bg.userData.backgroundColorAlpha;
      if (me._ht_image_bg.userData.ggSubElement) {
        me._ht_image_bg.userData.ggSubElement.material.opacity = v;
        me._ht_image_bg.userData.ggSubElement.visible =
          v > 0 && me._ht_image_bg.userData.visible;
      }
    ...
    me._ht_image_bg.logicBlock_scaling = function () {
      var newLogicStateScaling;
      if (me.elementMouseOver["ht_image_bg"] == true) {
        newLogicStateScaling = 0;
      } else {
        newLogicStateScaling = -1;
      }
      if (me._ht_image_bg.ggCurrentLogicStateScaling != newLogicStateScaling) {
        ...
        if (me._ht_image_bg.ggCurrentLogicStateScaling == 0) {
          me._ht_image_bg.userData.transitionValue_scale = {
            x: 1.2,
            y: 1.2,
            z: 1.0,
          };
          for (
            var i = 0;
            i < me._ht_image_bg.userData.transitions.length;
            i++
          ) {
          ...
          transition_scale.interval = setInterval(() => {
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._ht_image_bg.scale.set(
              transition_scale.startScale.x +
                (me._ht_image_bg.userData.transitionValue_scale.x -
                  transition_scale.startScale.x) *
                  tfval,
              transition_scale.startScale.y +
                (me._ht_image_bg.userData.transitionValue_scale.y -
                  transition_scale.startScale.y) *
                  tfval,
              1.0
            );
            var scaleOffX = 0;
            var scaleOffY = 0;
            me._ht_image_bg.position.x =
              me._ht_image_bg.position.x -
              me._ht_image_bg.userData.curScaleOffX +
              scaleOffX;
            me._ht_image_bg.userData.curScaleOffX = scaleOffX;
            me._ht_image_bg.position.y =
              me._ht_image_bg.position.y -
              me._ht_image_bg.userData.curScaleOffY +
              scaleOffY;
            me._ht_image_bg.userData.curScaleOffY = scaleOffY;
            if (percentDone >= 1.0) {
              clearInterval(transition_scale.interval);
              me._ht_image_bg.userData.transitions.splice(
                me._ht_image_bg.userData.transitions.indexOf(transition_scale),
                1
              );
            }
          }, 20);
    ...
    me._ht_image_bg.logicBlock_visible = function () {
      ...
      if (me._ht_image_bg.ggCurrentLogicStateVisible != newLogicStateVisible) {
        ...
        if (me._ht_image_bg.ggCurrentLogicStateVisible == 0) {
          me._ht_image_bg.visible =
            (!me._ht_image_bg.material &&
              Number(me._ht_image_bg.userData.opacity > 0)) ||
            Number(me._ht_image_bg.material.opacity) > 0
              ? true
              : false;
    ...
    me._ht_image_bg.logicBlock_alpha = function () {
      ...
      if (me._ht_image_bg.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
        ...
        if (me._ht_image_bg.ggCurrentLogicStateAlpha == 0) {
          ...
          transition_alpha.property = "alpha";
          transition_alpha.startTime = Date.now();
          transition_alpha.startAlpha = me._ht_image_bg.material
            ? me._ht_image_bg.material.opacity
            : me._ht_image_bg.userData.opacity;
          transition_alpha.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            let percentDone =
              (1.0 * (currentTime - transition_alpha.startTime)) / 200;
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._ht_image_bg.userData.setOpacity(
              transition_alpha.startAlpha +
                (me._ht_image_bg.userData.transitionValue_alpha -
                  transition_alpha.startAlpha) *
                  tfval
            );
            if (percentDone >= 1.0) {
              clearInterval(transition_alpha.interval);
              me._ht_image_bg.userData.transitions.splice(
                me._ht_image_bg.userData.transitions.indexOf(transition_alpha),
                1
              );
            }
          }, 20);
    ...
    me._ht_image_bg.userData.onclick = function (e) {
      player.setVariableValue(
        "open_image_hs",
        player.getVariableValue("open_image_hs") + "<" + me.hotspot.id + ">"
      );
    };
    ...
    el.userData.setOpacityInternal = function (v) {
      ...
      if (me._ht_image_title.userData.ggSubElement) {
        ...
        me._ht_image_title.userData.ggSubElement.visible =
          v > 0 && me._ht_image_title.userData.visible;
      }
    ...
    el.userData.setBackgroundColorAlpha = function (v) {
      ...
      me._ht_image_title.userData.setOpacity(
        me._ht_image_title.userData.opacity
      );
    };
    el.translateX(0);
    el.translateY(-0.325);
    ...
    el.userData.ggWrapText = function (scrollbar) {
      ...
      for (var i = 0; i < words.length; i++) {
        if (words[i] == "\n") {
          ...
          line = "";
          me._ht_image_title.userData.totalHeightCanv +=
            me._ht_image_title.userData.lineHeightCanv;
          continue;
        }
        var testLine;
        if (line == "") {
        ...
        if (
          testWidth >
            2 *
              (me._ht_image_title.userData.width - 0 - (scrollbar ? 25 : 0)) &&
          i > 0
        ) {
          me._ht_image_title.userData.textLines.push(line);
          line = words[i];
    ...
    el.userData.ggPaintCanvasText = function () {
      ...
      ctx.fillStyle =
        "rgba(" +
        me._ht_image_title.userData.textColor.r * 255 +
        ", " +
        me._ht_image_title.userData.textColor.g * 255 +
        ", " +
        me._ht_image_title.userData.textColor.b * 255 +
        ", " +
        me._ht_image_title.userData.textColorAlpha +
        ")";
      ctx.textBaseline = "top";
      var x =
        (me._ht_image_title.userData.boxWidthCanv -
          (me._ht_image_title.userData.hasScrollbar ? 50 : 0)) /
        2;
      ctx.textAlign = "center";
      var y = 2 * 3;
      ...
      geometry = new THREE.PlaneGeometry(
        me._ht_image_title.userData.boxWidthCanv / 200.0,
        me._ht_image_title.userData.boxHeightCanv / 200.0,
        5,
        5
      );
      geometry.name = "ht_image_title_geometry";
      ...
      var diffY =
        me._ht_image_title.userData.boxHeightCanv / 2 -
        me._ht_image_title.userData.height;
      me._ht_image_title.position.y =
        me._ht_image_title.userData.y - diffY / 2.0 / 100.0;
      var textTexture = new THREE.CanvasTexture(canv);
    ...
    el.userData.ggRenderText = function () {
      ...
      me._ht_image_title.userData.textLines = [];
      me._ht_image_title.userData.textLines.push(
        me._ht_image_title.userData.ggText
      );
      me._ht_image_title.userData.totalHeightCanv = 2 * 3;
      me._ht_image_title.userData.totalHeightCanv +=
        me._ht_image_title.userData.lineHeightCanv;
      me._ht_image_title.userData.boxWidthCanv =
        ctx.measureText(me._ht_image_title.userData.ggText).width + 2 * 0;
      me._ht_image_title.userData.boxHeightCanv =
        me._ht_image_title.userData.totalHeightCanv;
    ...
    me._ht_image_title.logicBlock_alpha = function () {
      ...
      if (me._ht_image_title.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
        ...
        if (me._ht_image_title.ggCurrentLogicStateAlpha == 0) {
          ...
          for (
            var i = 0;
            i < me._ht_image_title.userData.transitions.length;
            i++
          ) {
            if (
              me._ht_image_title.userData.transitions[i].property == "alpha"
            ) {
              clearInterval(
                me._ht_image_title.userData.transitions[i].interval
              );
          ...
          transition_alpha.property = "alpha";
          transition_alpha.startTime = Date.now();
          transition_alpha.startAlpha = me._ht_image_title.material
            ? me._ht_image_title.material.opacity
            : me._ht_image_title.userData.opacity;
          transition_alpha.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            let percentDone =
            ...
            me._ht_image_title.userData.setOpacity(
              transition_alpha.startAlpha +
                (me._ht_image_title.userData.transitionValue_alpha -
                  transition_alpha.startAlpha) *
                  tfval
            );
            if (percentDone >= 1.0) {
              clearInterval(transition_alpha.interval);
              me._ht_image_title.userData.transitions.splice(
                me._ht_image_title.userData.transitions.indexOf(
                  transition_alpha
                ),
                1
              );
    ...
    el.userData.borderColorAlpha = 1;
    el.userData.setOpacityInternal = function (v) {
      me._ht_image_popup_bg.material.opacity =
        v * me._ht_image_popup_bg.userData.backgroundColorAlpha;
      if (me._ht_image_popup_bg.userData.ggSubElement) {
        me._ht_image_popup_bg.userData.ggSubElement.material.opacity = v;
        me._ht_image_popup_bg.userData.ggSubElement.visible =
          v > 0 && me._ht_image_popup_bg.userData.visible;
      }
      me._ht_image_popup_bg.visible =
        v > 0 && me._ht_image_popup_bg.userData.visible;
    };
    el.userData.setBackgroundColor = function (v) {
    ...
    el.userData.setBackgroundColorAlpha = function (v) {
      ...
      me._ht_image_popup_bg.userData.setOpacity(
        me._ht_image_popup_bg.userData.opacity
      );
    };
    el.translateX(0);
    el.translateY(0);
    ...
    me._ht_image_popup_bg.logicBlock_scaling = function () {
      ...
      if (
        ...
        if (me._ht_image_popup_bg.ggCurrentLogicStateScaling == 0) {
          me._ht_image_popup_bg.userData.transitionValue_scale = {
            x: 1,
            y: 1,
            z: 1.0,
          };
          for (
            var i = 0;
            i < me._ht_image_popup_bg.userData.transitions.length;
            i++
          ) {
            if (
              me._ht_image_popup_bg.userData.transitions[i].property == "scale"
            ) {
              clearInterval(
                me._ht_image_popup_bg.userData.transitions[i].interval
              );
          ...
          transition_scale.interval = setInterval(() => {
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._ht_image_popup_bg.scale.set(
              transition_scale.startScale.x +
                (me._ht_image_popup_bg.userData.transitionValue_scale.x -
                  transition_scale.startScale.x) *
                  tfval,
              transition_scale.startScale.y +
                (me._ht_image_popup_bg.userData.transitionValue_scale.y -
                  transition_scale.startScale.y) *
                  tfval,
              1.0
            );
            var scaleOffX = 0;
            var scaleOffY = 0;
            me._ht_image_popup_bg.position.x =
              me._ht_image_popup_bg.position.x -
              me._ht_image_popup_bg.userData.curScaleOffX +
              scaleOffX;
            me._ht_image_popup_bg.userData.curScaleOffX = scaleOffX;
            me._ht_image_popup_bg.position.y =
              me._ht_image_popup_bg.position.y -
              me._ht_image_popup_bg.userData.curScaleOffY +
              scaleOffY;
            me._ht_image_popup_bg.userData.curScaleOffY = scaleOffY;
            if (percentDone >= 1.0) {
              clearInterval(transition_scale.interval);
              me._ht_image_popup_bg.userData.transitions.splice(
                me._ht_image_popup_bg.userData.transitions.indexOf(
                  transition_scale
                ),
                1
              );
      ...
      if (
        ...
        if (me._ht_image_popup_bg.ggCurrentLogicStateAlpha == 0) {
          ...
          for (
            ...
            if (
              me._ht_image_popup_bg.userData.transitions[i].property == "alpha"
            ) {
              clearInterval(
                me._ht_image_popup_bg.userData.transitions[i].interval
              );
          ...
          transition_alpha.property = "alpha";
          transition_alpha.startTime = Date.now();
          transition_alpha.startAlpha = me._ht_image_popup_bg.material
            ? me._ht_image_popup_bg.material.opacity
            : me._ht_image_popup_bg.userData.opacity;
          transition_alpha.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            ...
            me._ht_image_popup_bg.userData.setOpacity(
              transition_alpha.startAlpha +
                (me._ht_image_popup_bg.userData.transitionValue_alpha -
                  transition_alpha.startAlpha) *
                  tfval
            );
            if (percentDone >= 1.0) {
    ...
    me._ht_image_popup_bg.userData.ggUpdatePosition = function (
      useTransition
    ) {};
    el = new THREE.Group();
    el.userData.backgroundColorAlpha = 1;
    ...
    el.userData.setOpacityInternal = function (v) {
      if (me._ht_image_popup.userData.ggSubElement) {
        ...
        me._ht_image_popup.userData.ggSubElement.visible =
          v > 0 && me._ht_image_popup.userData.visible;
      }
    ...
    el.userData.ggSetUrl = function (extUrl) {
      loader.load(extUrl, function (texture) {
        ...
        me._ht_image_popup.userData.setOpacity(
          me._ht_image_popup.userData.opacity
        );
      });
    };
    ...
    el.userData.setOpacityInternal = function (v) {
      if (me._ht_image_popup_close.material)
        me._ht_image_popup_close.material.opacity = v;
      me._ht_image_popup_close.visible =
        v > 0 && me._ht_image_popup_close.userData.visible;
    };
    el.userData.isVisible = function () {
    ...
    me._ht_image_popup_close.userData.onmouseenter = function (e) {
      me._ht_image_popup_close.material =
        me._ht_image_popup_close.userData.materialOver;
      me.elementMouseOver["ht_image_popup_close"] = true;
    };
    me._ht_image_popup_close.userData.onmouseleave = function (e) {
      me._ht_image_popup_close.material =
        me._ht_image_popup_close.userData.materialNormal;
      me.elementMouseOver["ht_image_popup_close"] = false;
    };
    me._ht_image_popup_close.userData.ggUpdatePosition = function (
      useTransition
    ) {};
    ...
    el.userData.setOpacityInternal = function (v) {
      if (me._ht_image_customimage.userData.ggSubElement) {
        ...
        me._ht_image_customimage.userData.ggSubElement.visible =
          v > 0 && me._ht_image_customimage.userData.visible;
      }
      me._ht_image_customimage.visible =
        v > 0 && me._ht_image_customimage.userData.visible;
    };
    el.translateX(0);
    el.translateY(0);
    ...
    el.userData.ggSetUrl = function (extUrl) {
      loader.load(extUrl, function (texture) {
        ...
        me._ht_image_customimage.userData.ggSubElement.material =
          loadedMaterial;
        me._ht_image_customimage.userData.ggUpdatePosition();
        me._ht_image_customimage.userData.ggText = extUrl;
        me._ht_image_customimage.userData.setOpacity(
          me._ht_image_customimage.userData.opacity
        );
      });
    };
    if (hotspot && hotspot.customimage) {
    ...
    me._ht_image_customimage.logicBlock_visible = function () {
      ...
      if (
        me._ht_image_customimage.ggCurrentLogicStateVisible !=
        newLogicStateVisible
      ) {
        me._ht_image_customimage.ggCurrentLogicStateVisible =
          newLogicStateVisible;
        if (me._ht_image_customimage.ggCurrentLogicStateVisible == 0) {
          ...
          me._ht_image_customimage.visible =
            (!me._ht_image_customimage.material &&
              Number(me._ht_image_customimage.userData.opacity > 0)) ||
            Number(me._ht_image_customimage.material.opacity) > 0
              ? true
              : false;
    ...
    me._ht_image_customimage.userData.ggUpdatePosition = function (
      useTransition
    ) {
    ...
    me._ht_image.userData.setOpacity(1.0);
    me.elementMouseOver["ht_image"] = false;
    me._ht_image_bg.logicBlock_scaling();
    me._ht_image_bg.logicBlock_visible();
    me._ht_image_bg.logicBlock_alpha();
    me._ht_image_bg.userData.setOpacity(1.0);
    me.elementMouseOver["ht_image_bg"] = false;
    me._ht_image_icon.userData.setOpacity(1.0);
    me._ht_image_title.logicBlock_alpha();
    me._ht_image_title.userData.setOpacity(0.0);
    me._ht_image_popup_bg.logicBlock_scaling();
    me._ht_image_popup_bg.logicBlock_alpha();
    me._ht_image_popup_bg.userData.setOpacity(0.0);
    me._ht_image_popup.userData.setOpacity(1.0);
    me._ht_image_popup_close.userData.setOpacity(1.0);
    me.elementMouseOver["ht_image_popup_close"] = false;
    me._ht_image_customimage.logicBlock_visible();
    me._ht_image_customimage.userData.setOpacity(1.0);
    me.ggEvent_activehotspotchanged = function () {
      me._ht_image_bg.logicBlock_visible();
      me._ht_image_customimage.logicBlock_visible();
    };
  ...
  function SkinHotspotClass_ht_node(parentScope, hotspot) {
    ...
    el.userData.borderColorAlpha = 1;
    el.userData.setOpacityInternal = function (v) {
      me._ht_node_bg.material.opacity =
        v * me._ht_node_bg.userData.backgroundColorAlpha;
      if (me._ht_node_bg.userData.ggSubElement) {
        me._ht_node_bg.userData.ggSubElement.material.opacity = v;
        me._ht_node_bg.userData.ggSubElement.visible =
          v > 0 && me._ht_node_bg.userData.visible;
      }
    ...
    me._ht_node_bg.logicBlock_visible = function () {
      ...
      if (me._ht_node_bg.ggCurrentLogicStateVisible != newLogicStateVisible) {
        ...
        if (me._ht_node_bg.ggCurrentLogicStateVisible == 0) {
          me._ht_node_bg.visible =
            (!me._ht_node_bg.material &&
              Number(me._ht_node_bg.userData.opacity > 0)) ||
            Number(me._ht_node_bg.material.opacity) > 0
              ? true
              : false;
    ...
    el.userData.ggNodeId = nodeId;
    texture = loader.load(
      basePath + "images_vr/ht_node_image_" + nodeId + ".webp"
    );
    texture.colorSpace = player.getVRTextureColorSpace();
    material = new THREE.MeshBasicMaterial({
      map: texture,
    ...
    el.translateX(0);
    el.translateY(0);
    el.scale.set(0.3, 0.3, 1.0);
    el.userData.width = 150;
    el.userData.height = 150;
    el.userData.scale = { x: 0.3, y: 0.3, z: 1.0 };
    el.userData.curScaleOffX = 0;
    el.userData.curScaleOffY = 0;
    ...
    me._ht_node_image.logicBlock_scaling = function () {
      var newLogicStateScaling;
      if (me.elementMouseOver["ht_node_bg"] == true) {
        newLogicStateScaling = 0;
      } else {
        newLogicStateScaling = -1;
      }
      if (
        ...
        if (me._ht_node_image.ggCurrentLogicStateScaling == 0) {
          me._ht_node_image.userData.transitionValue_scale = {
            x: 1,
            y: 1,
            z: 1.0,
          };
          for (
            var i = 0;
            i < me._ht_node_image.userData.transitions.length;
            i++
          ) {
          ...
          transition_scale.interval = setInterval(() => {
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._ht_node_image.scale.set(
              transition_scale.startScale.x +
                (me._ht_node_image.userData.transitionValue_scale.x -
                  transition_scale.startScale.x) *
                  tfval,
              transition_scale.startScale.y +
                (me._ht_node_image.userData.transitionValue_scale.y -
                  transition_scale.startScale.y) *
                  tfval,
              1.0
            );
            var scaleOffX = 0;
            var scaleOffY = 0;
            me._ht_node_image.position.x =
              me._ht_node_image.position.x -
              me._ht_node_image.userData.curScaleOffX +
              scaleOffX;
            me._ht_node_image.userData.curScaleOffX = scaleOffX;
            me._ht_node_image.position.y =
              me._ht_node_image.position.y -
              me._ht_node_image.userData.curScaleOffY +
              scaleOffY;
            me._ht_node_image.userData.curScaleOffY = scaleOffY;
            if (percentDone >= 1.0) {
              clearInterval(transition_scale.interval);
              me._ht_node_image.userData.transitions.splice(
                me._ht_node_image.userData.transitions.indexOf(
                  transition_scale
                ),
                1
              );
    ...
    me._ht_node_image.logicBlock_alpha = function () {
      ...
      if (me._ht_node_image.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
        ...
        if (me._ht_node_image.ggCurrentLogicStateAlpha == 0) {
          ...
          transition_alpha.property = "alpha";
          transition_alpha.startTime = Date.now();
          transition_alpha.startAlpha = me._ht_node_image.material
            ? me._ht_node_image.material.opacity
            : me._ht_node_image.userData.opacity;
          transition_alpha.interval = setInterval(() => {
            let currentTime = Date.now() - 0;
            let percentDone =
              (1.0 * (currentTime - transition_alpha.startTime)) / 300;
            ...
            percentDone = Math.min(percentDone, 1.0);
            let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
            me._ht_node_image.userData.setOpacity(
              transition_alpha.startAlpha +
                (me._ht_node_image.userData.transitionValue_alpha -
                  transition_alpha.startAlpha) *
                  tfval
            );
            if (percentDone >= 1.0) {
    ...
    el.userData.setOpacityInternal = function (v) {
      ...
      if (me._ht_node_title.userData.ggSubElement) {
        ...
        me._ht_node_title.userData.ggSubElement.visible =
          v > 0 && me._ht_node_title.userData.visible;
      }
    ...
    el.userData.ggWrapText = function (scrollbar) {
      ...
      for (var i = 0; i < words.length; i++) {
        if (words[i] == "\n") {
          ...
          line = "";
          me._ht_node_title.userData.totalHeightCanv +=
            me._ht_node_title.userData.lineHeightCanv;
          continue;
        }
        var testLine;
        if (line == "") {
        ...
        if (
          testWidth >
            2 *
              (me._ht_node_title.userData.width - 10 - (scrollbar ? 25 : 0)) &&
          i > 0
        ) {
          me._ht_node_title.userData.textLines.push(line);
          line = words[i];
    ...
    el.userData.ggPaintCanvasText = function () {
      ...
      ctx.fillStyle =
        "rgba(" +
        me._ht_node_title.userData.backgroundColor.r * 255 +
        ", " +
        me._ht_node_title.userData.backgroundColor.g * 255 +
        ", " +
        me._ht_node_title.userData.backgroundColor.b * 255 +
        ", " +
        me._ht_node_title.userData.backgroundColorAlpha +
        ")";
      ctx.fillRect(0, 0, canv.width, canv.height);
      ctx.fillStyle =
        "rgba(" +
        me._ht_node_title.userData.textColor.r * 255 +
        ", " +
        me._ht_node_title.userData.textColor.g * 255 +
        ", " +
        me._ht_node_title.userData.textColor.b * 255 +
        ", " +
        me._ht_node_title.userData.textColorAlpha +
        ")";
      ctx.textBaseline = "top";
      var x =
        (me._ht_node_title.userData.boxWidthCanv -
          (me._ht_node_title.userData.hasScrollbar ? 50 : 0)) /
        2;
      ctx.textAlign = "center";
      var y = 2 * 13;
      y +=
        (canv.height - me._ht_node_title.userData.totalHeightCanv - 2 * 5) / 2;
    ...
    el.userData.ggRenderText = function () {
      ...
      me._ht_node_title.userData.boxWidthCanv =
        2 * me._ht_node_title.userData.width;
      me._ht_node_title.userData.boxHeightCanv =
        2 * me._ht_node_title.userData.height;
    ...
    me._ht_node_title.logicBlock_visible = function () {
      ...
      if (
        ...
        if (me._ht_node_title.ggCurrentLogicStateVisible == 0) {
          ...
          me._ht_node_title.visible =
            (!me._ht_node_title.material &&
              Number(me._ht_node_title.userData.opacity > 0)) ||
            Number(me._ht_node_title.material.opacity) > 0
              ? true
              : false;
    ...
    el.userData.setOpacityInternal = function (v) {
      if (me._ht_node_customimage.userData.ggSubElement) {
        ...
        me._ht_node_customimage.userData.ggSubElement.visible =
          v > 0 && me._ht_node_customimage.userData.visible;
      }
      me._ht_node_customimage.visible =
        v > 0 && me._ht_node_customimage.userData.visible;
    };
    el.translateX(0);
    el.translateY(0);
    ...
    el.userData.ggSetUrl = function (extUrl) {
      loader.load(extUrl, function (texture) {
        ...
        me._ht_node_customimage.userData.setOpacity(
          me._ht_node_customimage.userData.opacity
        );
      });
    };
    if (hotspot && hotspot.customimage) {
    ...
    me._ht_node_customimage.logicBlock_visible = function () {
      ...
      if (
        me._ht_node_customimage.ggCurrentLogicStateVisible !=
        newLogicStateVisible
      ) {
        me._ht_node_customimage.ggCurrentLogicStateVisible =
          newLogicStateVisible;
        if (me._ht_node_customimage.ggCurrentLogicStateVisible == 0) {
          ...
          me._ht_node_customimage.visible =
            (!me._ht_node_customimage.material &&
              Number(me._ht_node_customimage.userData.opacity > 0)) ||
            Number(me._ht_node_customimage.material.opacity) > 0
              ? true
              : false;
    ...
    me._ht_node_customimage.userData.ggUpdatePosition = function (
      useTransition
    ) {
    ...
    me._ht_node.userData.setOpacity(1.0);
    me.elementMouseOver["ht_node"] = false;
    me._ht_node_bg.logicBlock_visible();
    me._ht_node_bg.userData.setOpacity(1.0);
    me.elementMouseOver["ht_node_bg"] = false;
    me._ht_node_icon.userData.setOpacity(1.0);
    me._ht_node_image.logicBlock_scaling();
    me._ht_node_image.logicBlock_alpha();
    me._ht_node_image.userData.setOpacity(0.0);
    me._ht_node_title.logicBlock_visible();
    me._ht_node_title.userData.setOpacity(1.0);
    me._ht_node_customimage.logicBlock_visible();
    me._ht_node_customimage.userData.setOpacity(1.0);
    me.ggEvent_activehotspotchanged = function () {
      me._ht_node_bg.logicBlock_visible();
      me._ht_node_title.logicBlock_visible();
      me._ht_node_customimage.logicBlock_visible();
  ...
  player.addListener("vrconfigloaded", function () {
    me.addSkin();
    if (me.eventconfigloadedCallback) me.eventconfigloadedCallback();
    if (me.eventchangenodeCallback) me.eventchangenodeCallback();
  });
  player.addListener("exitvr", function () {
    me.removeSkin();
  });
  me.skinTimerEvent();
}
